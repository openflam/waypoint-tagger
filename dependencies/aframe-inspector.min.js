    ...
    n = {
        ...
        function a(t, n, r) {
          return (
            ...
            (function (t, n) {
              ...
              t,
              l()
                ? Reflect.construct(n, r || [], c(t).constructor)
                : n.apply(t, r)
            )
          );
        }
        ...
        !(function () {
          ...
          var e = (function (e) {
              function t(e) {
                ...
                return (
                  i(this, t),
                  ((n = a(this, t)).depthTest = !1),
                  (n.depthWrite = !1),
                  (n.fog = !1),
                  (n.side = THREE.FrontSide),
                  (n.transparent = !0),
                  n.setValues(e),
                  (n.oldColor = n.color.clone()),
              ...
              return u(t, THREE.MeshBasicMaterial), r(t);
            })(),
            n = (function (e) {
              function t(e) {
                var n;
              ...
              return u(t, THREE.LineBasicMaterial), r(t);
            })(),
            o = new e({ visible: !1, transparent: !1 });
          (THREE.TransformGizmo = (function (e) {
            function t() {
              return i(this, t), a(this, t, arguments);
            }
            return (
              u(t, THREE.Object3D),
              r(t, [
            ...
            (THREE.TransformGizmoTranslate = (function (t) {
              function s() {
                var t;
                i(this, s), (t = a(this, s));
                var r = new THREE.ConeGeometry(0.05, 0.2, 12, 1, !1);
                r.translate(0, 0.5, 0);
                ...
                return (
                  ...
                  (t.handleGizmos = {
                    X: [
                      [
                        new THREE.Mesh(r, new e({ color: 16711680 })),
                        [0.5, 0, 0],
                        [0, 0, -Math.PI / 2]
                      ],
                      [new THREE.Line(l, new n({ color: 16711680 }))]
                    ],
                    Y: [
                      [new THREE.Mesh(r, new e({ color: 65280 })), [0, 0.5, 0]],
                      [new THREE.Line(c, new n({ color: 65280 }))]
                    ],
                    Z: [
                      [
                        new THREE.Mesh(r, new e({ color: 255 })),
                        [0, 0, 0.5],
                        [Math.PI / 2, 0, 0]
                      ],
                  ...
                  (t.pickerGizmos = {
                    ...
                    XYZ: [
                      [new THREE.Mesh(new THREE.OctahedronGeometry(0.2, 0), o)]
                    ],
                    XY: [
                      [
                        new THREE.Mesh(new THREE.PlaneGeometry(0.4, 0.4), o),
                        [0.2, 0.2, 0]
                      ]
                    ],
                    YZ: [
              ...
              return (
                ...
                r(s, [
                  ...
                  },
                  {
                    key: 'update',
                    value: function (e, n) {
                      t(c(s.prototype), 'update', this).call(this, e, n);
                      ...
                      o.copy(this.planes.XY.rotation),
                        ...
                        this.traverse(function (e) {
                          i.setFromEuler(o),
                            'X' === e.name &&
                              (p.setFromAxisAngle(a, Math.atan2(-m.y, m.z)),
                              i.multiplyQuaternions(i, p),
                              e.quaternion.copy(i)),
                            'Y' === e.name &&
                              (f.setFromAxisAngle(l, Math.atan2(m.x, m.z)),
                              i.multiplyQuaternions(i, f),
                              e.quaternion.copy(i)),
                            'Z' === e.name &&
                              (d.setFromAxisAngle(u, Math.atan2(m.y, m.x)),
            ...
            (THREE.TransformGizmoScale = (function (t) {
              function s() {
                var t;
                i(this, s), (t = a(this, s));
                var r = new THREE.BoxGeometry(0.125, 0.125, 0.125);
                r.translate(0, 0.5, 0);
                var l = new THREE.BufferGeometry();
                l.setAttribute(
                  'position',
                ...
                return (
                  ...
                  (t.pickerGizmos = {
                    ...
                    XYZ: [
                      [new THREE.Mesh(new THREE.BoxGeometry(0.4, 0.4, 0.4), o)]
                    ]
                  }),
                  t.init(),
                  t
            ...
            (THREE.TransformControls = (function (e) {
              function t(e, n) {
                ...
                for (var f in p) {
                  var d = p[f];
                  (d.visible = f === c), r.add(d);
                }
                var m = { type: 'change' },
                  h = { type: 'mouseDown' },
                  y = { type: 'mouseUp', mode: c },
                  g = { type: 'objectChange' },
                ...
                function $(e) {
                  if (
                    ...
                    var t = J(
                        ...
                        p[c].pickers.children
                      ),
                      n = null;
                    t && ((n = t.object.name), e.preventDefault()),
                      l.axis !== n &&
                        ((l.axis = n), l.update(), l.dispatchEvent(m));
                  }
                }
                function X(e) {
                  if (
                    ...
                    if (0 === t.button || void 0 === t.button) {
                      var n = J(t, p[c].pickers.children);
                      if (n) {
                        e.preventDefault(),
                          e.stopPropagation(),
                          (l.axis = n.object.name),
                          l.dispatchEvent(h),
                          l.update(),
                          S.copy(G).sub(Y).normalize(),
                          p[c].setActivePlane(l.axis, S);
                        var r = J(t, [p[c].activePlane]);
                        r &&
                          (D.copy(l.object.position),
                          F.copy(l.object.scale),
                          H.extractRotation(l.object.matrix),
                          Q.extractRotation(l.object.matrixWorld),
                          V.extractRotation(l.object.parent.matrixWorld),
                          U.setFromMatrixScale(
                            k.copy(l.object.parent.matrixWorld).invert()
                          ),
                          C.copy(r.point));
                      }
                    }
                    ...
                    if (!1 !== t) {
                      if (
                        ...
                        A.sub(C),
                          A.multiply(U),
                          'local' === l.space &&
                            (A.applyMatrix4(k.copy(Q).invert()),
                            -1 === l.axis.search('X') && (A.x = 0),
                            -1 === l.axis.search('Y') && (A.y = 0),
                            -1 === l.axis.search('Z') && (A.z = 0),
                            A.applyMatrix4(H),
                            l.object.position.copy(D),
                            l.object.position.add(A)),
                          ('world' !== l.space &&
                            -1 === l.axis.search('XYZ')) ||
                            (-1 === l.axis.search('X') && (A.x = 0),
                            -1 === l.axis.search('Y') && (A.y = 0),
                            ...
                            l.object.position.copy(D),
                            l.object.position.add(A)),
                          null !== l.translationSnap &&
                            ('local' === l.space &&
                              l.object.position.applyMatrix4(
                                k.copy(Q).invert()
                              ),
                            -1 !== l.axis.search('X') &&
                              (l.object.position.x =
                                Math.round(
                                  l.object.position.x / l.translationSnap
                                ) * l.translationSnap),
                            -1 !== l.axis.search('Y') &&
                              (l.object.position.y =
                                Math.round(
                                  l.object.position.y / l.translationSnap
                                ) * l.translationSnap),
                            -1 !== l.axis.search('Z') &&
                              (l.object.position.z =
                                Math.round(
                                  l.object.position.z / l.translationSnap
                                ) * l.translationSnap),
                            'local' === l.space &&
                              l.object.position.applyMatrix4(Q));
                      else if ('scale' === c)
                        A.sub(C),
                          A.multiply(U),
                          'local' === l.space &&
                            ('XYZ' === l.axis
                              ? ((E = 1 + A.y / Math.max(F.x, F.y, F.z)),
                                (l.object.scale.x = F.x * E),
                                (l.object.scale.y = F.y * E),
                                (l.object.scale.z = F.z * E))
                              : (A.applyMatrix4(k.copy(Q).invert()),
                                'X' === l.axis &&
                                  (l.object.scale.x = F.x * (1 + A.x / F.x)),
                                'Y' === l.axis &&
                                  (l.object.scale.y = F.y * (1 + A.y / F.y)),
                                'Z' === l.axis &&
                                  (l.object.scale.z = F.z * (1 + A.z / F.z))));
                      else if ('rotate' === c)
                        if (
                          (A.sub(Y),
                          A.multiply(U),
                          ...
                          A.applyMatrix4(k.copy(O).invert()),
                            M.applyMatrix4(k.copy(O).invert()),
                            w.set(
                              Math.atan2(A.z, A.y),
                              Math.atan2(A.x, A.z),
                              Math.atan2(A.y, A.x)
                            ...
                            j.setFromRotationMatrix(k.copy(V).invert()),
                            z.setFromAxisAngle(S, w.z - x.z),
                            N.setFromRotationMatrix(Q),
                            j.multiplyQuaternions(j, z),
                            j.multiplyQuaternions(j, N),
                            l.object.quaternion.copy(j);
                        else if ('XYZE' === l.axis) {
                          var n = A.clone().cross(M).normalize();
                          z.setFromEuler(T.set(n.x, n.y, n.z)),
                            j.setFromRotationMatrix(k.copy(V).invert()),
                            L.setFromAxisAngle(z, -A.clone().angleTo(M)),
                            N.setFromRotationMatrix(Q),
                            j.multiplyQuaternions(j, L),
                            j.multiplyQuaternions(j, N),
                            l.object.quaternion.copy(j);
                        } else
                          'local' === l.space
                            ? (A.applyMatrix4(k.copy(Q).invert()),
                              M.applyMatrix4(k.copy(Q).invert()),
                              w.set(
                                Math.atan2(A.z, A.y),
                                Math.atan2(A.x, A.z),
                                Math.atan2(A.y, A.x)
                              ...
                              null !== l.rotationSnap
                                ? (L.setFromAxisAngle(
                                    I,
                                    Math.round((w.x - x.x) / l.rotationSnap) *
                                      l.rotationSnap
                                  ),
                                  _.setFromAxisAngle(
                                    P,
                                    Math.round((w.y - x.y) / l.rotationSnap) *
                                      l.rotationSnap
                                  ),
                                  B.setFromAxisAngle(
                                    R,
                                    Math.round((w.z - x.z) / l.rotationSnap) *
                                      l.rotationSnap
                                  ))
                                : (L.setFromAxisAngle(I, w.x - x.x),
                                  _.setFromAxisAngle(P, w.y - x.y),
                                  B.setFromAxisAngle(R, w.z - x.z)),
                              'X' === l.axis && N.multiplyQuaternions(N, L),
                              'Y' === l.axis && N.multiplyQuaternions(N, _),
                              'Z' === l.axis && N.multiplyQuaternions(N, B),
                              l.object.quaternion.copy(N))
                            : 'world' === l.space &&
                              (w.set(
                                Math.atan2(A.z, A.y),
                                Math.atan2(A.x, A.z),
                              ...
                              null !== l.rotationSnap
                                ...
                                : (L.setFromAxisAngle(I, w.x - x.x),
                                  ...
                                  B.setFromAxisAngle(R, w.z - x.z)),
                              N.setFromRotationMatrix(Q),
                              'X' === l.axis && j.multiplyQuaternions(j, L),
                              'Y' === l.axis && j.multiplyQuaternions(j, _),
                              'Z' === l.axis && j.multiplyQuaternions(j, B),
                              j.multiplyQuaternions(j, N),
                              l.object.quaternion.copy(j));
                      'translate' === c
                        ? ((l.object.position.x = parseFloat(
                            l.object.position.x.toFixed(5)
                          )),
                          (l.object.position.y = parseFloat(
                            l.object.position.y.toFixed(5)
                          )),
                          (l.object.position.z = parseFloat(
                            l.object.position.z.toFixed(5)
                          )))
                        : 'rotate' === c
                          ? ((l.object.rotation.x = parseFloat(
                              l.object.rotation.x.toFixed(5)
                            )),
                            (l.object.rotation.y = parseFloat(
                              l.object.rotation.y.toFixed(5)
                            )),
                            (l.object.rotation.z = parseFloat(
                              l.object.rotation.z.toFixed(5)
                            )))
                          : ((l.object.scale.x = parseFloat(
                              l.object.scale.x.toFixed(5)
                            )),
                            (l.object.scale.y = parseFloat(
                              l.object.scale.y.toFixed(5)
                            )),
                            (l.object.scale.z = parseFloat(
                              l.object.scale.z.toFixed(5)
                            ))),
                        l.update(),
                        l.dispatchEvent(m),
                        (g.mode = c),
                ...
                function K(e) {
                  e.preventDefault(),
                    (void 0 !== e.button && 0 !== e.button) ||
                      (u &&
                        null !== l.axis &&
                        ((y.mode = c), l.dispatchEvent(y)),
                      (u = !1),
                      'TouchEvent' in window && e instanceof TouchEvent
                        ? ((l.axis = null), l.update(), l.dispatchEvent(m))
                        : $(e));
                }
                function J(e, t) {
                  var r = n.getBoundingClientRect(),
                    i = (e.clientX - r.left) / r.width,
                    a = (e.clientY - r.top) / r.height;
                  v.set(2 * i - 1, -2 * a + 1), b.setFromCamera(v, o);
                  var s = b.intersectObjects(t, !0);
                  return !!s[0] && s[0];
                }
                return (
                  (r.setCamera = function (e) {
                    o = e;
                  }),
                  (r.activate = function () {
                    n.addEventListener('mousedown', X, !1),
                      n.addEventListener('touchstart', X, !1),
                      n.addEventListener('mousemove', $, !1),
                      n.addEventListener('touchmove', $, !1),
                      n.addEventListener('mousemove', q, !1),
                      n.addEventListener('touchmove', q, !1),
                      n.addEventListener('mouseup', K, !1),
                      n.addEventListener('mouseout', K, !1),
                      n.addEventListener('touchend', K, !1),
                      n.addEventListener('touchcancel', K, !1),
                      n.addEventListener('touchleave', K, !1);
                  }),
                  r.activate(),
                  (r.dispose = function () {
                    n.removeEventListener('mousedown', X),
                      n.removeEventListener('touchstart', X),
                      n.removeEventListener('mousemove', $),
                      n.removeEventListener('touchmove', $),
                      n.removeEventListener('mousemove', q),
                      n.removeEventListener('touchmove', q),
                      n.removeEventListener('mouseup', K),
                      n.removeEventListener('mouseout', K),
                      n.removeEventListener('touchend', K),
                      n.removeEventListener('touchcancel', K),
                      n.removeEventListener('touchleave', K);
                  }),
                  (r.attach = function (e) {
                  ...
                  (r.setMode = function (e) {
                    for (var t in ('scale' === (c = e || c) &&
                      (l.space = 'local'),
                    p))
                      p[t].visible = t === c;
                    this.update(), l.dispatchEvent(m);
                  }),
                  (r.setTranslationSnap = function (e) {
                    l.translationSnap = e;
                  }),
                  (r.setRotationSnap = function (e) {
                    l.rotationSnap = e;
                  }),
                  (r.setSize = function (e) {
                    (l.size = e), this.update(!0), l.dispatchEvent(m);
                  }),
                  (r.setSpace = function (e) {
                    (l.space = e), this.update(), l.dispatchEvent(m);
                  }),
                  (r.update = function (e) {
                    void 0 !== l.object &&
                      (l.object.updateMatrixWorld(),
                      Y.setFromMatrixPosition(l.object.matrixWorld),
                      W.setFromRotationMatrix(
                        k.extractRotation(l.object.matrixWorld)
                      ),
                      o.updateMatrixWorld(),
                      G.setFromMatrixPosition(o.matrixWorld),
                      Z.setFromRotationMatrix(k.extractRotation(o.matrixWorld)),
                      (E = (Y.distanceTo(G) / 6) * l.size),
                      this.position.copy(Y),
                      e && this.scale.set(E, E, E),
                      ...
                      'local' === l.space
                        ? p[c].update(W, S)
                        : 'world' === l.space &&
                          p[c].update(new THREE.Euler(), S),
                      p[c].highlight(l.axis));
                  }),
                  r
                );
              }
              return u(t, THREE.Object3D), r(t);
            })());
        })();
      },
      253: (e, t, n) => {
        ...
        var r = n(324),
          o = {};
        r.A.on('entityupdate', function (e) {
          var t = e.value,
            n = e.entity;
          o[n.id] = o[n.id] || {};
      ...
      181: (e, t, n) => {
        ...
        e.exports = function (e, t, n) {
          ...
          function C(e) {
            return (s = void 0), g && r ? b(e) : ((r = o = void 0), a);
          }
          function w() {
            var e = m(),
              n = v(e);
            if (((r = arguments), (o = this), (l = e), n)) {
              if (void 0 === s)
                return (function (e) {
                  return (c = e), (s = setTimeout(A, t)), u ? b(e) : a;
                })(l);
              if (p) return (s = setTimeout(A, t)), b(l);
            }
      ...
      551: (e, t, n) => {
        ...
        function He(e, t, n, r, o, i, a, s, l) {
          (_e = !1), (Be = null), Le.apply(Fe, arguments);
        }
        function Ve(e) {
          var t = e,
            n = e;
        ...
        function Gt(e, t, n, r) {
          if (Yt) {
            var o = $t(e, t, n, r);
            if (null === o) Yr(e, t, r, Zt, n), Lt(e, r);
            else if (
              (function (e, t, n, r, o) {
                switch (t) {
                  case 'focusin':
                  ...
                  case 'gotpointercapture':
                    return (
                      (i = o.pointerId),
                      Pt.set(i, _t(Pt.get(i) || null, e, t, n, r, o)),
                      !0
                    );
                }
                return !1;
              ...
              for (; null !== o; ) {
                ...
                if (
                  (null !== i && Ct(i),
                  null === (i = $t(e, t, n, r)) && Yr(e, t, r, Zt, n),
                  i === o)
                )
                  break;
                o = i;
        ...
        var an,
          ...
          mn = on(dn),
          hn = on(B({}, dn, { dataTransfer: 0 })),
          yn = on(B({}, pn, { relatedTarget: 0 })),
          gn = on(
            B({}, cn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 })
          ),
          bn = B({}, cn, {
        ...
        var Sn = B({}, pn, {
          ...
          Tn = on(
            B({}, cn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 })
          ),
          In = B({}, dn, {
            deltaX: function (e) {
              return 'deltaX' in e
        ...
        var Sr = Or('animationend'),
          kr = Or('animationiteration'),
          Mr = Or('animationstart'),
          jr = Or('transitionend'),
          Tr = new Map(),
          Ir =
        ...
        for (var Rr = 0; Rr < Ir.length; Rr++) {
          var Nr = Ir[Rr];
          Pr(Nr.toLowerCase(), 'on' + (Nr[0].toUpperCase() + Nr.slice(1)));
        }
        Pr(Sr, 'onAnimationEnd'),
          Pr(kr, 'onAnimationIteration'),
          Pr(Mr, 'onAnimationStart'),
            ...
            if (0 == (7 & t)) {
              if (
                ...
                if (
                  ...
                  e: {
                    for (f = c, m = 0, d = u = l; d; d = Gr(d)) m++;
                    for (d = 0, h = f; h; h = Gr(h)) d++;
                    for (; 0 < m - d; ) (u = Gr(u)), m--;
                    for (; 0 < d - m; ) (f = Gr(f)), d--;
                    for (; m--; ) {
        ...
        function Zr(e, t, n, r, o) {
          for (var i = t._reactName, a = []; null !== n && n !== r; ) {
            ...
            5 === s.tag &&
              ...
              ((s = c),
              o
                ? null != (l = Pe(n, i)) && a.unshift(Wr(n, l, s))
                : o || (null != (l = Pe(n, i)) && a.push(Wr(n, l, s)))),
              (n = n.return);
          }
        ...
        function Lo(e, t, n) {
          if (jo.current !== Mo) throw Error(i(168));
          ko(jo, t), ko(To, n);
        }
        function _o(e, t, n) {
          var r = e.stateNode;
        ...
        function Uo() {
          if (!Ho && null !== Do) {
            ...
            try {
              ...
              throw (null !== Do && (Do = Do.slice(e + 1)), Ge(Je, Uo), t);
            } finally {
              (vt = t), (Ho = !1);
            }
          }
        ...
        var Yo = [],
          ...
          Ko = '';
        function Jo(e, t) {
          (Yo[Wo++] = Go), (Yo[Wo++] = Qo), (Qo = e), (Go = t);
        }
        function ei(e, t, n) {
          (Zo[$o++] = qo), (Zo[$o++] = Ko), (Zo[$o++] = Xo), (Xo = e);
          var r = qo;
          e = Ko;
          var o = 32 - at(r) - 1;
          (r &= ~(1 << o)), (n += 1);
        ...
        function ni(e) {
          for (; e === Qo; )
            (Qo = Yo[--Wo]), (Yo[Wo] = null), (Go = Yo[--Wo]), (Yo[Wo] = null);
          for (; e === Xo; )
            (Xo = Zo[--$o]),
              (Zo[$o] = null),
              (Ko = Zo[--$o]),
        ...
        function zi(e, t, n, r) {
          ...
          if (null !== i) {
            ...
            (Bl |= a), (e.lanes = a), (e.memoizedState = p);
          }
        }
        function Di(e, t, n) {
        ...
        var Vi = {
          ...
          enqueueSetState: function (e, t, n) {
            ...
            (i.payload = t),
              null != n && (i.callback = n),
              null !== (t = Li(e, i, o)) && (rc(t, e, o, r), _i(t, e, o));
          },
          ...
          enqueueForceUpdate: function (e, t) {
            ...
            (o.tag = 2),
              null != t && (o.callback = t),
              null !== (t = Li(e, o, r)) && (rc(t, e, r, n), _i(t, e, r));
          }
        };
        ...
        function Yi(e, t, n) {
          ...
          return (
            'object' == typeof i && null !== i
              ? (i = Si(i))
              : ((o = Ro(t) ? Io : jo.current),
                (i = (r = null != (r = t.contextTypes)) ? Po(e, o) : Mo)),
            (t = new t(n, i)),
            (e.memoizedState =
        ...
        function Qi(e, t, n, r) {
          ...
          'object' == typeof i && null !== i
            ? (o.context = Si(i))
            : ((i = Ro(t) ? Io : jo.current), (o.context = Po(e, i))),
        ...
        function Xi(e) {
          ...
          function y(o, s, l, c) {
            ...
            for (
              var p = (u = null), h = s, y = (s = 0), g = null, b = l.next();
              null !== h && !b.done;
              y++, b = l.next()
            ) {
              h.index > y ? ((g = h), (h = null)) : (g = h.sibling);
              var v = d(o, h, b.value, c);
              if (null === v) {
                null === h && (h = g);
                break;
              }
            ...
            if (b.done) return n(o, h), ii && Jo(o, y), u;
            if (null === h) {
              ...
              switch (a.$$typeof) {
                case C:
                  e: {
                    ...
                    a.type === x
                      ? (((i = _c(a.props.children, r.mode, l, a.key)).return =
                          r),
                        (r = i))
                      : (((l = Lc(
                          a.type,
        ...
        function Pa(e, t) {
          ...
          if (
            ...
            if (
              ((n.flags |= 2048),
              Da(9, Na.bind(null, n, r, o, t), void 0, null),
              null === Tl)
            )
              throw Error(i(349));
            0 != (30 & ma) || Ra(n, t, o);
        ...
        function Na(e, t, n, r) {
          (t.value = n), (t.getSnapshot = r), _a(t) && Ba(e);
        }
        function La(e, t, n) {
          return n(function () {
            _a(t) && Ba(e);
        ...
        function Ka(e, t, n) {
          return 0 == (21 & ma)
            ? (e.baseState && ((e.baseState = !1), (As = !0)),
              (e.memoizedState = n))
            : (sr(n, t) ||
                ((n = ht()), (ha.lanes |= n), (Bl |= n), (e.baseState = !0)),
              t);
        }
        function Ja(e, t) {
          var n = vt;
        ...
        var as = {
          ...
          ss = {
            ...
            useImperativeHandle: function (e, t, n) {
              return (
                (n = null != n ? n.concat([e]) : null),
                Ha(4194308, 4, Ga.bind(null, t, e), n)
              );
            },
            ...
            useTransition: function () {
              var e = za(!1),
                t = e[0];
              return (
                (e = Ja.bind(null, e[1])), (Sa().memoizedState = e), [t, e]
              );
            },
            ...
            useSyncExternalStore: function (e, t, n) {
              ...
              return (
                ...
                (r.flags |= 2048),
                Da(9, Na.bind(null, r, a, n, t), void 0, null),
                n
              );
            },
            useId: function () {
          ...
          ls = {
            ...
            useTransition: function () {
              return [ja(Ma)[0], ka().memoizedState];
            },
            useMutableSource: Ia,
          ...
          cs = {
            ...
            useTransition: function () {
              return [Ta(Ma)[0], ka().memoizedState];
            },
            useMutableSource: Ia,
            useSyncExternalStore: Pa,
            useId: es,
        ...
        function Ms(e, t, n, r, o) {
          ...
          if ((Oi(t, o), null === t.stateNode))
            Ys(e, t), Yi(t, n, r), Qi(t, n, r, o), (r = !0);
          else if (null === e) {
            var a = t.stateNode,
              s = t.memoizedProps;
            a.props = s;
            ...
            (a.state = f),
              zi(t, r, a, o),
              (l = t.memoizedState),
              s !== r || f !== l || To.current || Ii
                ? ('function' == typeof u &&
                    (Hi(t, n, u, r), (l = t.memoizedState)),
                  (s = Ii || Ui(t, n, s, r, f, l, c))
                    ? (p ||
            ...
            (a = t.stateNode),
              Ri(e, t),
              (s = t.memoizedProps),
              (c = t.type === t.elementType ? s : gi(t.type, s)),
              (a.props = c),
              (p = t.pendingProps),
              (f = a.context),
              (l =
            ...
            s !== p || f !== m || To.current || Ii
              ? ('function' == typeof d &&
                  (Hi(t, n, d, r), (m = t.memoizedState)),
                (c = Ii || Ui(t, n, c, r, f, m, l) || !1)
                  ? (u ||
        ...
        function zs(e, t, n) {
          ...
          if (null !== (a = e.memoizedState) && null !== (r = a.dehydrated))
            return (function (e, t, n, r, o, a, s) {
              if (n)
                return 256 & t.flags
                  ? ((t.flags &= -257), Fs(e, t, s, (r = ps(Error(i(422))))))
              ...
              if ('$!' === o.data) {
                if ((r = o.nextSibling && o.nextSibling.dataset))
                  var l = r.dgst;
                return (
                  (r = l), Fs(e, t, s, (r = ps((a = Error(i(419))), r, void 0)))
                );
              }
              if (((l = 0 != (s & e.childLanes)), As || l)) {
                if (null !== (r = Tl)) {
                  ...
                  0 !== (o = 0 != (o & (r.suspendedLanes | s)) ? 0 : o) &&
                    o !== a.retryLane &&
                    ((a.retryLane = o), Ti(e, o), rc(r, e, o, -1));
                }
                return yc(), Fs(e, t, s, (r = ps(Error(i(421)))));
              }
              return '$?' === o.data
                ? ((t.flags |= 128),
                  (t.child = e.child),
            ...
            return (
              0 == (1 & l) && t.child !== a
                ? (((o = t.child).childLanes = 0),
                  (o.pendingProps = c),
                  (t.deletions = null))
                : ((o = Nc(a, c)).subtreeFlags = 14680064 & a.subtreeFlags),
              null !== r
                ? (s = Nc(r, s))
                : ((s = _c(s, l, n, null)).flags |= 2),
              (s.return = t),
              (o.return = t),
              (o.sibling = s),
              (t.child = o),
          ...
          return (
            (e = (s = e.child).sibling),
            (o = Nc(s, { mode: 'visible', children: o.children })),
        ...
        function Zs(e, t, n) {
          ...
          switch ((ni(t), t.tag)) {
            ...
            case 10:
              return xi(t.type._context), Gs(t), null;
            case 19:
              if ((So(la), null === (a = t.memoizedState))) return Gs(t), null;
              ...
              try {
                ...
                e: for (; null !== l; ) {
                  switch (l.tag) {
                    ...
                    case 3:
                    case 4:
                      (pl = l.stateNode.containerInfo), (fl = !0);
                      break e;
                  }
                  l = l.return;
                }
                if (null === pl) throw Error(i(160));
                ml(a, s, o), (pl = null), (fl = !1);
                var c = o.alternate;
        ...
        function gl(e, t) {
          ...
          switch (e.tag) {
            ...
            case 15:
              ...
              break;
            case 1:
              yl(t, e), bl(e), 512 & r && null !== n && el(n, n.return);
              break;
            case 5:
              if (
                (yl(t, e),
            ...
            case 22:
              if (
                ...
                if (
                  ...
                  for (Js = e, p = e.child; null !== p; ) {
                    for (f = Js = p; null !== Js; ) {
                      switch (((m = (d = Js).child), d.tag)) {
                        case 0:
                        case 11:
                        case 14:
                        case 15:
                    ...
                    (l = (a = Js).child),
                      22 === a.tag && null !== a.memoizedState
                        ...
                        : null !== l
                          ? ((l.return = a), (Js = l))
                          : xl(o);
                for (; null !== i; ) (Js = i), Al(i, t, n), (i = i.sibling);
                (Js = o), (Xs = s), (qs = c);
              }
              Cl(e);
            } else
        ...
        var El,
          ...
          kl = A.ReactCurrentOwner,
          Ml = A.ReactCurrentBatchConfig,
          jl = 0,
          Tl = null,
          Il = null,
          Pl = 0,
          ...
          ec = 0;
        function tc() {
          return 0 != (6 & jl) ? qe() : -1 !== Jl ? Jl : (Jl = qe());
        }
        function nc(e) {
          return 0 == (1 & e.mode)
            ? 1
        ...
        function ic(e, t) {
          if (((Jl = -1), (ec = 0), 0 != (6 & jl))) throw Error(i(327));
          var n = e.callbackNode;
          ...
          if (0 != (30 & r) || 0 != (r & e.expiredLanes) || t) t = gc(e, r);
            ...
            wi(),
              (Sl.current = a),
              (jl = o),
              null !== Il ? (t = 0) : ((Tl = null), (Pl = 0), (t = Ll));
          }
          if (0 !== t) {
            if (
              (2 === t && 0 !== (o = mt(e)) && ((r = o), (t = ac(e, o))),
              1 === t)
            )
              throw ((n = _l), dc(e, 0), lc(e, r), oc(e, qe()), n);
            if (6 === t) lc(e, r);
            else {
              if (
              ...
              switch (((e.finishedWork = o), (e.finishedLanes = r), t)) {
                ...
                case 3:
                  if (
                    ...
                    e.timeoutHandle = ro(wc.bind(null, e, Hl, Yl), t);
                    break;
                  }
                  wc(e, Hl, Yl);
                  break;
                case 4:
                  ...
                  if (
                    ...
                    e.timeoutHandle = ro(wc.bind(null, e, Hl, Yl), r);
                    break;
                  }
                  wc(e, Hl, Yl);
                  break;
          ...
          return oc(e, qe()), e.callbackNode === n ? ic.bind(null, e) : null;
        }
        function ac(e, t) {
          var n = Fl;
          return (
            e.current.memoizedState.isDehydrated && (dc(e, t).flags |= 256),
            2 !== (e = gc(e, t)) && ((t = Hl), (Hl = n), null !== t && sc(t)),
            e
          );
        }
        function sc(e) {
        ...
        function cc(e) {
          ...
          if (1 === n) throw ((n = _l), dc(e, 0), lc(e, t), oc(e, qe()), n);
        ...
        function uc(e, t) {
          ...
          try {
            ...
            0 === (jl = n) && ((Ul = qe() + 500), Fo && Uo());
          }
        }
        function pc(e) {
          null !== $l && 0 === $l.tag && 0 == (6 & jl) && xc();
          var t = jl;
          jl |= 1;
          var n = Ml.transition,
            r = vt;
          try {
            if (((Ml.transition = null), (vt = 1), e)) return e();
          } finally {
            (vt = r), (Ml.transition = n), 0 == (6 & (jl = t)) && Uo();
          }
        }
        function fc() {
          (Rl = Nl.current), So(Nl);
        ...
        function dc(e, t) {
          ...
          if ((-1 !== n && ((e.timeoutHandle = -1), oo(n)), null !== Il))
        ...
        function gc(e, t) {
          ...
          if ((wi(), (jl = n), (Sl.current = r), null !== Il))
            throw Error(i(261));
          return (Tl = null), (Pl = 0), Ll;
        }
        function bc() {
          for (; null !== Il; ) Ac(Il);
        }
        ...
        function Cc(e) {
          ...
          do {
            ...
            if (((e = t.return), 0 == (32768 & t.flags))) {
              if (null !== (n = Zs(n, t, Rl))) return void (Il = n);
            } else {
              if (null !== (n = $s(n, t)))
        ...
        function xc() {
          if (null !== $l) {
            var e = At(Xl),
              ...
              n = vt;
            try {
              if (((Ml.transition = null), (vt = 16 > e ? 16 : e), null === $l))
                var r = !1;
              else {
                if (((e = $l), ($l = null), (Xl = 0), 0 != (6 & jl)))
                  throw Error(i(331));
                var o = jl;
                for (jl |= 4, Js = e.current; null !== Js; ) {
                  var a = Js,
                    s = a.child;
                  if (0 != (16 & Js.flags)) {
                    var l = a.deletions;
        ...
        function Sc(e, t, n) {
          ...
          null !== r && r.delete(t),
            ...
            Tl === e &&
              (Pl & n) === n &&
              (4 === Ll ||
              (3 === Ll && (130023424 & Pl) === Pl && 500 > qe() - Vl)
                ? dc(e, 0)
                : (Dl |= n)),
            oc(e, t);
        }
        ...
        function Lc(e, t, n, r, o, a) {
          ...
          if (((r = e), 'function' == typeof e)) Rc(e) && (s = 1);
            ...
            e: switch (e) {
              case x:
                return _c(n.children, o, a, t);
              case E:
                (s = 8), (o |= 8);
                break;
              case O:
                return (
                  ((e = Pc(12, n, t, 2 | o)).elementType = O), (e.lanes = a), e
                );
              case j:
                return (
                  ((e = Pc(13, n, t, o)).elementType = j), (e.lanes = a), e
                );
              case T:
                return (
                  ((e = Pc(19, n, t, o)).elementType = T), (e.lanes = a), e
                );
              case R:
                return Bc(n, o, a, t);
              default:
        ...
        function Uc(e, t, n, r, o, i, a, s, l) {
          return (
            ((e = Hc(n, r, !0, e, 0, i, 0, s, l)).context = Vc(null)),
            (n = e.current),
            ((i = Ni((r = tc()), (o = nc(n)))).callback = null != t ? t : null),
            Li(n, i, o),
            (e.current.lanes = o),
            gt(e, o, r),
            oc(e, r),
        ...
        function Yc(e, t, n, r) {
          ...
          return (
            ...
            null !== (e = Li(o, t, a)) && (rc(e, o, a, i), _i(e, o, a)),
            a
          );
        }
        function Wc(e) {
        ...
        El = function (e, t, n) {
          if (null !== e)
            if (e.memoizedProps !== t.pendingProps || To.current) As = !0;
            else {
                  ...
                  (function (e, t, n) {
                    switch (t.tag) {
                      ...
                      case 10:
                        ...
                        ko(bi, r._currentValue), (r._currentValue = o);
                        break;
                      case 13:
          ...
          else (As = !1), ii && 0 != (1048576 & t.flags) && ei(t, Go, t.index);
          switch (((t.lanes = 0), t.tag)) {
            case 2:
              var r = t.type;
              Ys(e, t), (e = t.pendingProps);
              var o = Po(t, jo.current);
            ...
            case 1:
              return (
                (r = t.type),
                (o = t.pendingProps),
                Ms(e, t, r, (o = t.elementType === r ? o : gi(r, o)), n)
              );
            case 3:
              e: {
            ...
            case 11:
              return (
                (r = t.type),
                (o = t.pendingProps),
                ws(e, t, r, (o = t.elementType === r ? o : gi(r, o)), n)
              );
            case 7:
        ...
        (t.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = tu),
          ...
          (t.hydrateRoot = function (e, t, n) {
            ...
            if (
              ...
              (t = Uc(t, null, e, 1, null != n ? n : null, o, 0, a, s)),
              (e[ho] = t.current),
              Vr(e),
              r)
            )
      ...
      287: (e, t) => {
        ...
        (A.constructor = v), h(A, g.prototype), (A.isPureReactComponent = !0);
        var C = Array.isArray,
        ...
        function O(e, t, r) {
          ...
          if (null != t)
            ...
            t))
              w.call(t, o) && !E.hasOwnProperty(o) && (i[o] = t[o]);
            ...
            return (
              ...
              i > a
                ? ((e.sortIndex = i),
                  ...
                  null === r(c) &&
                    e === r(u) &&
                    (y ? (b(S), (S = -1)) : (y = !0), N(C, i - a)))
                : ((e.sortIndex = s), n(c, e), h || m || ((h = !0), R(w))),
              e
            );
          }),
    ...
    (() => {
      ...
      function a(e) {
        var n = (function (e) {
            ...
            (o.refreshObjects = function () {
              ...
              e.container.addEventListener('mousedown', u),
              e.container.addEventListener('mouseup', p),
              e.container.addEventListener('dblclick', f),
              e.sceneEl.canvas.addEventListener('mouseleave', function () {
                setTimeout(function () {
                  t.A.emit('raycastermouseleave', null);
                });
              });
            ...
            function f(r) {
              ...
              a && t.A.emit('objectfocus', a.object3D);
            }
            return {
              el: n,
              enable: function () {
              ...
              disable: function () {
                n.setAttribute('raycaster', 'enabled', !1),
                  e.container.removeEventListener('mousedown', u),
                  e.container.removeEventListener('mouseup', p),
                  e.container.removeEventListener('dblclick', f);
              }
            };
          })(e),
          o = e.sceneEl;
        ...
        (p.size = 0.75),
          p.addEventListener('objectChange', function (e) {
            ...
            if (void 0 !== n) {
              var r, o;
              if ((l.setFromObject(n), c(n), 'translate' === e.mode))
                (r = 'position'),
                  (o = ''
                    .concat(n.position.x, ' ')
                    .concat(n.position.y, ' ')
                ...
                'scale' === e.mode &&
                  ...
                  (o = ''
                    ...
                    .concat(n.scale.y, ' ')
                    .concat(n.scale.z)));
              p.object.el.setAttribute(r, o),
                t.A.emit('entityupdate', {
                  component: r,
                  entity: p.object.el,
                  property: '',
                  value: o
          ...
          a.add(p),
          t.A.on('entityupdate', function (t) {
        ...
        f.center.set(0, 1.6, 0),
          ...
          t.A.on('cameratoggle', function (e) {
            f.setCamera(e.camera), p.setCamera(e.camera);
          }),
          d(),
          t.A.on('inspectorcleared', function () {
            f.center.set(0, 0, 0);
          }),
          t.A.on('transformmodechange', function (e) {
            p.setMode(e);
          }),
          t.A.on('translationsnapchanged', function (e) {
            p.setTranslationSnap(e);
          }),
          t.A.on('rotationsnapchanged', function (e) {
            p.setRotationSnap(e);
          }),
          t.A.on('transformspacechanged', function (e) {
            p.setSpace(e);
          }),
          t.A.on('objectselect', function (e) {
            (l.visible = !1),
              p.detach(),
              e &&
                e.el &&
          ...
          t.A.on('objectfocus', function (e) {
            f.focus(e), p.update();
          }),
          t.A.on('geometrychanged', function (e) {
          ...
          t.A.on('windowresize', function () {
            (u.aspect = e.container.offsetWidth / e.container.offsetHeight),
              u.updateProjectionMatrix();
          }),
          t.A.on('gridvisibilitychanged', function (e) {
            s.visible = e;
          }),
          t.A.on('togglegrid', function () {
            s.visible = !s.visible;
          }),
          t.A.on('inspectortoggle', function (t) {
            t
              ? (d(),
      ...
      (THREE.EditorControls = function (e, t) {
        ...
        var n = e,
          ...
          a = new THREE.Vector3(),
          s = new THREE.Box3(),
          l = { NONE: -1, ROTATE: 0, ZOOM: 1, PAN: 2 },
          c = l.NONE,
          u = this.center,
          p = new THREE.Matrix3(),
          f = new THREE.Vector2(),
        ...
        (this.dispatchChange = r()(function () {
          ...
          (this.focus = function (e) {
            ...
            s.setFromObject(e),
              !1 !== s.isEmpty() || isNaN(s.min.x)
                ? (u.setFromMatrixPosition(e.matrixWorld), (t = 0.1))
                : (s.getCenter(u), (t = s.getBoundingSphere(h).radius)),
          ...
          (this.pan = function (e) {
            ...
            (t = this.isOrthographic
              ? Math.abs(n.right)
              : n.position.distanceTo(u)),
              e.multiplyScalar(t * o.panSpeed),
              e.applyMatrix3(p.getNormalMatrix(n.matrix)),
              n.position.add(e),
              u.add(e),
              o.dispatchChange();
          });
        ...
        (this.setAspectRatio = function (e) {
          ...
          (this.rotate = function (e) {
            this.rotationEnabled &&
              (i.copy(n.position).sub(u),
              m.setFromVector3(i),
              (m.theta += e.x),
              (m.phi += e.y),
              m.makeSafe(),
              i.setFromSpherical(m),
              n.position.copy(u).add(i),
              n.lookAt(u),
              o.dispatchChange());
          }),
          (this.dispose = function () {
            t.removeEventListener('contextmenu', w, !1),
              t.removeEventListener('mousedown', b, !1),
              t.removeEventListener('wheel', C, !1),
              t.removeEventListener('mousemove', v, !1),
              t.removeEventListener('mouseup', A, !1),
              t.removeEventListener('mouseout', A, !1),
              t.removeEventListener('dblclick', A, !1),
              t.removeEventListener('touchstart', S, !1),
              t.removeEventListener('touchmove', k, !1);
          }),
          t.addEventListener('contextmenu', w, !1),
          t.addEventListener('mousedown', b, !1),
          t.addEventListener('wheel', C, !1);
        var x = [new THREE.Vector3(), new THREE.Vector3(), new THREE.Vector3()],
        ...
        function S(e) {
          if (!1 !== o.enabled) {
            switch (e.touches.length) {
              case 1:
                x[0].set(e.touches[0].pageX, e.touches[0].pageY, 0),
                  x[1].set(e.touches[0].pageX, e.touches[0].pageY, 0);
                break;
              case 2:
                x[0].set(e.touches[0].pageX, e.touches[0].pageY, 0),
                  x[1].set(e.touches[1].pageX, e.touches[1].pageY, 0),
                  (O = x[0].distanceTo(x[1]));
            }
            E[0].copy(x[0]), E[1].copy(x[1]);
          }
        }
        function k(e) {
          if (!1 !== o.enabled) {
            switch (
              ...
              case 2:
                x[0].set(e.touches[0].pageX, e.touches[0].pageY, 0),
                  x[1].set(e.touches[1].pageX, e.touches[1].pageY, 0);
                var t = x[0].distanceTo(x[1]);
                o.zoom(a.set(0, 0, O - t)), (O = t);
                var n = x[0].clone().sub(i(x[0], E)),
                  r = x[1].clone().sub(i(x[1], E));
                (n.x = -n.x), (r.x = -r.x), o.pan(n.add(r).multiplyScalar(0.5));
            }
            E[0].copy(x[0]), E[1].copy(x[1]);
          }
          function i(e, t) {
        ...
        t.addEventListener('touchstart', S, !1),
          t.addEventListener('touchmove', k, !1);
      }),
      ...
      function y(e) {
        ...
        o.addEventListener(
          'loaded',
          function () {
            AFRAME.INSPECTOR.selectEntity(o), t.A.emit('entityclone', o);
          },
          { once: !0 }
        ),
          e.id &&
                    ...
                    r = (
                      C(e.schema)
                        ? function () {
                            var r = b(e, null, t);
                            return (
                              void 0 === r && (r = v(e, null, t)),
                              void 0 !== r ? (n = !0) : (r = A(e, null)),
          ...
          n.open('GET', r),
            (n.onload = function () {
              ...
              (e.images = r.images),
                ...
                t.A.emit('assetsimagesload', e.images);
            }),
            (n.onerror = function () {
      ...
      var E = {
          ...
          onKeyUp: function (e) {
            if (x(e) && AFRAME.INSPECTOR.opened) {
              var n = e.keyCode;
              if (
                (72 === n && t.A.emit('openhelpmodal'),
                27 === n &&
                  this.inspector.selectedEntity &&
                  this.inspector.selectEntity(null),
                87 === n && t.A.emit('transformmodechange', 'translate'),
                69 === n && t.A.emit('transformmodechange', 'rotate'),
                82 === n && t.A.emit('transformmodechange', 'scale'),
                79 === n && t.A.emit('transformspacechange'),
                71 === n && t.A.emit('togglegrid'),
                77 === n && t.A.emit('togglemotioncapture'),
                78 === n &&
                  t.A.emit('entitycreate', {
                    element: 'a-entity',
                    components: {}
                  }),
                (8 !== n && 46 !== n) || h(),
                ...
                null != r && t.A.emit('objectfocus', r.object3D);
              }
              for (var o in (49 === n
                ? t.A.emit('cameraperspectivetoggle')
                : 50 === n
                  ? t.A.emit('cameraorthographictoggle', 'left')
                  : 51 === n
                    ? t.A.emit('cameraorthographictoggle', 'right')
                    : 52 === n
                      ? t.A.emit('cameraorthographictoggle', 'top')
                      : 53 === n
                        ? t.A.emit('cameraorthographictoggle', 'bottom')
                        : 54 === n
                          ? t.A.emit('cameraorthographictoggle', 'back')
                          : 55 === n &&
                            t.A.emit('cameraorthographictoggle', 'front'),
          ...
          onKeyDown: function (e) {
            x(e) &&
              ...
              48 === e.keyCode &&
                (t.A.emit('togglesidebar', { which: 'all' }),
                e.preventDefault(),
                e.stopPropagation()));
          },
          enable: function () {
                        ...
                        icon: Array.isArray(r)
                          ? (0, U.jsx)('g', {
                              children: r.map(function (e, t) {
                                return (0, U.jsx)(
                                  'path',
                                  { fill: 'currentColor', d: e },
                                  t
                                );
                              })
                            })
                          : (0, U.jsx)('path', { fill: 'currentColor', d: r })
                      };
      ...
      function Ue(e) {
        return (je = Te = 1), (Ie = Se((Ne = e))), (Pe = 0), [];
      }
      function Ye(e) {
        return (Ne = ''), e;
      }
      function We(e) {
        return Ce(He(Pe - 1, Ze(91 === e ? e + 2 : 40 === e ? e + 1 : e)));
      }
      function Qe(e) {
        for (; (Re = De()) && Re < 33; ) ze();
        return Ve(e) > 2 || Ve(Re) > 3 ? '' : ' ';
      }
      function Ge(e, t) {
        for (
          ;
        ...
        return He(e, Fe() + (t < 6 && 32 == De() && 32 == ze()));
      }
      function Ze(e) {
        for (; ze(); )
          switch (Re) {
      ...
      function $e(e, t) {
        for (; ze() && e + Re !== 57 && (e + Re !== 84 || 47 !== De()); );
        return '/*' + He(t, Pe - 1) + '*' + ve(47 === e ? e : ze());
      }
      function Xe(e) {
        for (; !Ve(De()); ) ze();
        return He(e, Pe);
      ...
      function it(e, t, n, r) {
        ...
        return Se((n = ot(e.children, r)))
          ? (e.return = e.value + '{' + n + '}')
          : '';
      }
      function at(e) {
        return Ye(st('', null, null, null, [''], (e = Ue(e)), 0, [0], e));
      }
      function st(e, t, n, r, o, i, a, s, l) {
        for (
          var c = 0,
            u = 0,
            p = a,
          ...
          switch (((m = b), (b = ze()))) {
            case 40:
              if (108 != m && 58 == Ee(x, p - 1)) {
                -1 != xe((x += we(We(b), '&', '&\f')), '&\f') && (g = -1);
                break;
              }
            case 34:
            case 39:
            ...
            case 0:
              switch (b) {
                ...
                default:
                  if (
                    (Me(
                      (w = lt(x, t, n, c, u, o, s, v, (A = []), (C = []), p)),
                      i
                    ),
                    123 === b)
                  )
                    if (0 === u) st(x, t, w, w, A, i, p, s, C);
                    else
                      switch (99 === f && 110 === Ee(x, 3) ? 100 : f) {
                        case 100:
                        case 109:
                        case 115:
                          st(
            ...
            default:
              if (h < 1)
                if (123 == b) --h;
                else if (125 == b && 0 == h++ && 125 == Be()) continue;
              switch (((x += ve(b)), b * h)) {
                case 38:
                  g = u > 0 ? 1 : ((x += '\f'), -1);
                  break;
      ...
      function lt(e, t, n, r, o, i, a, s, l, c, u) {
        for (
          var p = o - 1, f = 0 === o ? i : [''], d = ke(f), m = 0, h = 0, y = 0;
          m < r;
          ++m
        )
          for (
            var g = 0, b = Oe(e, p + 1, (p = be((h = a[m])))), v = e;
            g < d;
            ++g
          )
            (v = Ce(h > 0 ? f[g] + ' ' + b : we(b, /&\f/g, f[g]))) &&
              (l[y++] = v);
        return Le(e, t, n, 0 === o ? tt : s, l, c, u);
      }
      function ct(e, t, n) {
        return Le(e, t, n, et, ve(Re), Oe(e, 2, -2), 0);
      }
      function ut(e, t, n, r) {
        return Le(e, t, n, nt, Oe(e, 0, r), Oe(e, r + 1, -1), r);
      }
      var pt = function (e, t, n) {
          for (
            var r = 0, o = 0;
            (r = o), (o = De()), 38 === r && 12 === o && (t[n] = 1), !Ve(o);
        ...
        dt = function (e) {
          if ('rule' === e.type && e.parent && !(e.length < 1)) {
            ...
            if (
              (1 !== e.props.length || 58 === t.charCodeAt(0) || ft.get(n)) &&
              !r
            ) {
              ft.set(e, !0);
              for (
      ...
      function ht(e, t) {
        switch (
          ...
          case 6968:
          case 2756:
            return Je + e + Ke + e + qe + e + e;
          case 6828:
          case 4268:
            return Je + e + qe + e + e;
          case 6165:
            return Je + e + qe + 'flex-' + e + e;
          case 5187:
            return (
              Je +
              e +
              we(e, /(\w+).+(:[^]+)/, Je + 'box-$1$2' + qe + 'flex-$1$2') +
              e
            );
          case 5443:
            return Je + e + qe + 'flex-item-' + we(e, /flex-|-self/, '') + e;
          case 4675:
            return (
              Je +
              e +
          ...
          case 5548:
            return Je + e + qe + we(e, 'shrink', 'negative') + e;
          case 5292:
            return Je + e + qe + we(e, 'basis', 'preferred-size') + e;
          case 6060:
            return (
              Je +
              'box-' +
          ...
          case 4765:
            if (Se(e) - 1 - t > 6)
              switch (Ee(e, t + 1)) {
                ...
                case 115:
                  return ~xe(e, 'stretch')
                    ? ht(we(e, 'stretch', 'fill-available'), t) + e
                    : e;
              }
            break;
          case 4949:
          ...
          case 6444:
            switch (Ee(e, Se(e) - 3 - (~xe(e, '!important') && 10))) {
              case 107:
                return we(e, ':', ':' + Je) + e;
              case 101:
                return (
          ...
          case 5936:
            switch (Ee(e, t + 11)) {
              case 114:
                return Je + e + qe + we(e, /[svh]\w+-[tblr]{2}/, 'tb') + e;
              case 108:
                return Je + e + qe + we(e, /[svh]\w+-[tblr]{2}/, 'tb-rl') + e;
              case 45:
                return Je + e + qe + we(e, /[svh]\w+-[tblr]{2}/, 'lr') + e;
            }
            return Je + e + qe + e + e;
        }
        return e;
          ...
          if (e.length > -1 && !e.return)
            switch (e.type) {
              case nt:
                ...
                break;
              case rt:
                return ot([_e(e, { value: we(e.value, '@', '@' + Je) })], r);
              case tt:
                if (e.length)
                  return (function (e, t) {
                    return e.map(t).join('');
                      ...
                      case '::placeholder':
                        return ot(
                          [
                            _e(e, {
                              props: [
                                we(t, /:(plac\w+)/, ':' + Je + 'input-$1')
                              ]
                            }),
                            _e(e, { props: [we(t, /:(plac\w+)/, ':-moz-$1')] }),
                            _e(e, {
                              props: [we(t, /:(plac\w+)/, qe + 'input-$1')]
                            })
                          ],
                          r
                        );
      ...
      var Ct = /[A-Z]|^ms/g,
        ...
        Ot = (function (e) {
          ...
          return function (e) {
            return (
              void 0 === t[e] &&
                (t[e] = xt((n = e)) ? n : n.replace(Ct, '-$&').toLowerCase()),
              t[e]
            );
            var n;
          };
        ...
        St = function (e, t) {
          ...
          return 1 === At[e] || xt(e) || 'number' != typeof t || 0 === t
            ? t
            : t + 'px';
        };
      function kt(e, t, n) {
        ...
        switch (typeof n) {
          ...
          case 'object':
            if (1 === n.anim)
              return (
                (Mt = { name: n.name, styles: n.styles, next: Mt }), n.name
              );
            if (void 0 !== n.styles) {
              var r = n.next;
              if (void 0 !== r)
                for (; void 0 !== r; )
                  (Mt = { name: r.name, styles: r.styles, next: Mt }),
                    (r = r.next);
              return n.styles + ';';
            }
            return (function (e, t, n) {
              var r = '';
              if (Array.isArray(n))
                for (var o = 0; o < n.length; o++) r += kt(e, t, n[o]) + ';';
              else
                for (var i in n) {
                  var a = n[i];
                  if ('object' != typeof a)
      ...
      var Mt,
        ...
        Tt = function (e, t, n) {
          ...
          for (var a = 1; a < e.length; a++)
            (o += kt(n, t, e[a])), r && (o += i[a]);
          jt.lastIndex = 0;
          for (var s, l = ''; null !== (s = jt.exec(o)); ) l += '-' + s[1];
          return { name: vt(o) + l, styles: o, next: Mt };
        },
        It =
        ...
        Pt = {}.hasOwnProperty,
        Rt = (0, O.createContext)(
          'undefined' != typeof HTMLElement ? gt({ key: 'css' }) : null
        );
      Rt.Provider;
      var Nt = function (e) {
          return (0, O.forwardRef)(function (t, n) {
            var r = (0, O.useContext)(Rt);
            return e(t, r, n);
          });
        },
        Lt = (0, O.createContext)({}),
        ...
        zt = Nt(function (e, t, n) {
          ...
          var s = Tt(i, void 0, (0, O.useContext)(Lt));
          a += t.key + '-' + s.name;
          var l = {};
          for (var c in e)
            Pt.call(e, c) && 'css' !== c && c !== _t && (l[c] = e[c]);
          return (
            (l.ref = n),
            (l.className = a),
            (0, O.createElement)(
              O.Fragment,
              null,
              (0, O.createElement)(Bt, {
                cache: t,
                serialized: s,
                isStringTag: 'string' == typeof o
              }),
              (0, O.createElement)(o, l)
            )
          );
        });
      o(146);
      var Dt = function (e, t) {
        ...
        (o[0] = zt),
          (o[1] = (function (e, t) {
            var n = {};
            for (var r in t) Pt.call(t, r) && (n[r] = t[r]);
            return (n[_t] = e), n;
          })(e, t));
      ...
      function en(e) {
        const t =
          !Gt(e) && e.contextElement ? e.contextElement : Gt(e) ? e : null;
        if (!t) return Jt;
        ...
        if ('border-box' !== r.boxSizing)
          return Qt(t)
            ? {
                x: (t.offsetWidth > 0 && Kt(n.width) / t.offsetWidth) || 1,
                y: (t.offsetHeight > 0 && Kt(n.height) / t.offsetHeight) || 1
              }
            : Jt;
      ...
      function tn(e, t, n, r) {
        ...
        let c = Jt;
        t && (r ? Gt(r) && (c = en(r)) : (c = en(e)));
        const u = Gt(e) ? Vt(e) : window,
          p = !qt() && n,
          f =
            (l.left +
              (p &&
      ...
      function on(e, t) {
        ...
        const r = rn(e),
          ...
          i = Vt(r);
        return o
          ? t.concat(i, i.visualViewport || [], Xt(r) ? r : [])
          : t.concat(r, on(r));
      }
      const an = O.useLayoutEffect;
      var sn = [
          'className',
          'clearValue',
          'cx',
      ...
      function un(e, t) {
        ...
        if (t && e)
          for (var a in t)
            t.hasOwnProperty(a) && t[a] && i.push(''.concat(cn(e, a)));
        return i
          .filter(function (e) {
            return e;
          })
      ...
      function yn(e, t) {
        mn(e) ? window.scrollTo(0, t) : (e.scrollTop = t);
      }
      function gn(e, t) {
        var n =
            arguments.length > 2 && void 0 !== arguments[2]
              ...
              : 200,
          r =
            arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : ln,
          o = hn(e),
          i = t - o,
          a = 0;
        !(function t() {
          var s,
            l = ((s = a += 10), i * ((s = s / n - 1) * s * s + 1) + o);
          yn(e, l), a < n ? window.requestAnimationFrame(t) : r(e);
        })();
      }
      function bn(e, t) {
        ...
        r.bottom + o > n.bottom
          ...
          : r.top - o < n.top && yn(e, Math.max(t.offsetTop - o, 0));
      }
      function vn() {
        try {
      ...
      wn.addEventListener &&
        wn.removeEventListener &&
        (wn.addEventListener('p', ln, Cn), wn.removeEventListener('p', ln, !1));
      var xn = An;
      function En(e) {
        return null != e;
      }
      ...
      var Mn,
        ...
        Rn = function (e) {
          var t = e.children,
            ...
            s = e.theme,
            l = ((0, O.useContext)(Pn) || {}).setPortalPlacement,
            c = (0, O.useRef)(null),
            u = le((0, O.useState)(r), 2),
            p = u[0],
            f = u[1],
            d = le((0, O.useState)(null), 2),
            m = d[0],
            h = d[1],
        ...
        Wn = Un,
        Qn = (function () {
          var e = Ft.apply(void 0, arguments),
            t = 'animation-' + e.name;
          return {
            name: t,
          ...
          Mn ||
            ...
            Tn || (Tn = jn.slice(0)),
            (Mn = Object.freeze(
              Object.defineProperties(jn, { raw: { value: Object.freeze(Tn) } })
            )))
        ),
        Gn = function (e) {
          var t = e.delay,
        ...
        er = {
          ...
          GroupHeading: function (e) {
            ...
            return Dt(
              'div',
              pe({}, dn(e, 'groupHeading', { 'group-heading': !0 }), n)
            );
          },
          IndicatorsContainer: function (e) {
            ...
            return Dt(
              'div',
              pe({}, dn(e, 'indicatorsContainer', { indicators: !0 }), n),
              t
            );
          },
          IndicatorSeparator: function (e) {
            ...
            return Dt(
              ...
              pe(
                {},
                t,
                dn(e, 'indicatorSeparator', { 'indicator-separator': !0 })
              )
            );
          },
          Input: function (e) {
            ...
            return Dt(
              'div',
              pe({}, dn(e, 'input', { 'input-container': !0 }), {
                'data-value': n || ''
              }),
              Dt(
                'input',
          ...
          LoadingIndicator: function (e) {
            ...
            return Dt(
              ...
              pe(
                {},
                dn(
                  ie(ie({}, i), {}, { innerProps: t, isRtl: n, size: o }),
                  'loadingIndicator',
                  { indicator: !0, 'loading-indicator': !0 }
                ),
                t
              ),
              Dt(Gn, { delay: 0, offset: n }),
              Dt(Gn, { delay: 160, offset: !0 }),
              Dt(Gn, { delay: 320, offset: !n })
            );
          },
          Menu: function (e) {
            var t = e.children,
          ...
          LoadingMessage: function (e) {
            ...
            return Dt(
              ...
              pe(
                {},
                dn(
                  ie(ie({}, o), {}, { children: n, innerProps: r }),
                  'loadingMessage',
            ...
            return Dt(
              ...
              Dt(
                c,
                {
                  ...
                  innerProps: ie(
                    {},
                    dn(e, 'multiValueLabel', { 'multi-value__label': !0 })
                  ),
                  selectProps: s
                },
                t
              ...
              Dt(u, {
                ...
                innerProps: ie(
                  ie(
                    {},
                    dn(e, 'multiValueRemove', { 'multi-value__remove': !0 })
                  ),
                  {},
          ...
          Placeholder: function (e) {
            ...
            return Dt(
              'div',
              pe({}, dn(e, 'placeholder', { placeholder: !0 }), n),
              t
            );
          },
          SelectContainer: function (e) {
            ...
            return Dt(
              ...
              pe(
                {},
                dn(e, 'container', { '--is-disabled': r, '--is-rtl': o }),
                n
              ),
              t
            );
      ...
      function nr(e, t) {
        ...
        for (var n = 0; n < e.length; n++)
          if (!((r = e[n]) === (o = t[n]) || (tr(r) && tr(o)))) return !1;
        var r, o;
        return !0;
      }
      for (
          ...
          ar = function (e) {
            var t = e.ariaSelection,
                ...
                function () {
                  ...
                  if (t && x.onChange) {
                    var r = t.option,
                      ...
                      d = f ? f.map(p) : [],
                      h = ie(
                        { isDisabled: c && m(c, a), label: u, labels: d },
                        t
                      );
                    n = x.onChange(h);
                  }
              ...
              k = (0, O.useMemo)(
                function () {
                  var e = '';
                  if (y && g.length && !A && x.onFilter) {
                    var t = b({ count: o.length });
                    e = x.onFilter({ inputValue: f, resultsMessage: t });
                  }
                  return e;
                },
                [o, f, y, x, g, b, A]
              ...
              j = (0, O.useMemo)(
                ...
                [C, n, r, d, m, h, y, x, a, v, M]
              ),
              T = Dt(
                O.Fragment,
                null,
                Dt('span', { id: 'aria-selection' }, E),
                Dt('span', { id: 'aria-focused' }, S),
                Dt('span', { id: 'aria-results' }, k),
                Dt('span', { id: 'aria-guidance' }, j)
              );
            return Dt(
              O.Fragment,
              null,
        ...
        for (var pr = sr[ur], fr = 0; fr < pr.letters.length; fr++)
          cr[pr.letters[fr]] = pr.base;
      var dr = function (e) {
      ...
      function br(e) {
        var t = e.innerRef,
          ...
          })(ce(e, gr), 'onExited', 'in', 'enter', 'exit', 'appear');
        return Dt(
          'input',
          pe({ ref: t }, n, {
            css: Ft(
              ...
              a = (0, O.useCallback)(
                function (e) {
                  if (Or) {
                    ...
                    t &&
                      Er() &&
                      (t.addEventListener('touchmove', Cr, kr),
                      e &&
                        (e.addEventListener('touchstart', xr, kr),
                        e.addEventListener('touchmove', wr, kr))),
                      (Sr += 1);
                  }
                },
                [r]
                ...
                function (e) {
                  if (Or) {
                    ...
                    (Sr = Math.max(Sr - 1, 0)),
                      ...
                      t &&
                        Er() &&
                        (t.removeEventListener('touchmove', Cr, kr),
                        e &&
                          (e.removeEventListener('touchstart', xr, kr),
                          e.removeEventListener('touchmove', wr, kr)));
                  }
                },
                [r]
              );
      ...
      var Lr = {
        ...
        Br = {
          ...
          blurInputOnSelect: vn(),
          captureMenuScroll: !vn(),
          classNames: {},
          closeMenuOnSelect: !0,
          closeMenuOnScroll: !1,
          components: {},
      ...
      function Vr(e, t) {
        var n = e.inputValue,
          ...
          a = t.label,
          s = t.value;
        return (!$r(e) || !i) && Zr(e, { label: a, value: s, data: o }, r);
      }
      var Ur = function (e, t) {
          var n;
          return (
            ...
            if (
              ...
              (t.selectOption = function (e) {
                ...
                if (s) {
                  ...
                  o
                    ? t.setValue([].concat(ye(a), [e]), 'select-option', e)
              ...
              (t.getFocusedOptionId = function (e) {
                return Ur(t.state.focusableOptionsWithIds, e);
              }),
              (t.getFocusableOptionsWithIds = function () {
                return Hr(
                  Dr(t.props, t.state.selectValue),
              ...
              (t.cx = function () {
                for (
                  ...
                  n[r] = arguments[r];
                return un.apply(void 0, [t.props.classNamePrefix].concat(n));
              }),
              ...
              (t.getComponents = function () {
                return (e = t.props), ie(ie({}, er), e.components);
                var e;
              }),
              (t.buildCategorizedOptions = function () {
                return Dr(t.props, t.state.selectValue);
              }),
              (t.getCategorizedOptions = function () {
                return t.props.menuIsOpen ? t.buildCategorizedOptions() : [];
              }),
              (t.buildFocusableOptions = function () {
                return Fr(t.buildCategorizedOptions());
              }),
              (t.getFocusableOptions = function () {
                return t.props.menuIsOpen ? t.buildFocusableOptions() : [];
              }),
              (t.ariaOnChange = function (e, n) {
                t.setState({ ariaSelection: ie({ value: e }, n) });
              }),
              ...
              (t.state.instancePrefix =
                'react-select-' + (t.props.instanceId || ++Xr)),
              (t.state.selectValue = pn(e.value)),
              ...
              (t.state.focusableOptionsWithIds = n),
                ...
                (t.state.focusedOptionId = Ur(n, r[a]));
            }
            return t;
          }
          return (
            ...
            (n = [
                ...
                value: function () {
                  this.startListeningComposition(),
                    ...
                    this.props.menuIsOpen &&
                      ...
                      bn(this.menuListRef, this.focusedOptionRef);
                }
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return O.createElement(
                    e,
                    pe({}, t, { innerProps: o, isDisabled: n, isFocused: r })
                  );
                }
              },
              {
                ...
                value: function () {
                  ...
                  if (this.hasOptions())
                    ...
                    j = O.createElement(s, u, I);
                  } else {
                    var P = S({ inputValue: m });
                    if (null === P) return null;
                    j = O.createElement(l, u, P);
                  }
                  var R = {
                      minMenuHeight: g,
                      maxMenuHeight: b,
                    ...
                    N = O.createElement(Rn, pe({}, u, R), function (t) {
                      var n = t.ref,
                        r = t.placerProps,
                        a = r.placement,
                        s = r.maxHeight;
                ...
                value: function (e, t) {
                  ...
                  return (
                    ...
                    ie(
                      ie(ie({}, h), A),
                      {},
                      { prevProps: e, ariaSelection: C, prevWasFocused: w }
                    )
                  );
                }
              }
      ...
      qr.defaultProps = Br;
      var Kr = (0, O.forwardRef)(function (e, t) {
          var n = (function (e) {
            var t = e.defaultInputValue,
              ...
              d = e.value,
              m = ce(e, ue),
              h = le((0, O.useState)(void 0 !== s ? s : n), 2),
              y = h[0],
              g = h[1],
              b = le((0, O.useState)(void 0 !== l ? l : o), 2),
              v = b[0],
              A = b[1],
              C = le((0, O.useState)(void 0 !== d ? d : a), 2),
              w = C[0],
              x = C[1],
              E = (0, O.useCallback)(
                function (e, t) {
                  'function' == typeof c && c(e, t), x(e);
                },
                [c]
              ),
              S = (0, O.useCallback)(
          ...
          return O.createElement(qr, pe({ ref: t }, n));
        }),
        Jr = Kr;
      function eo(e) {
        return (
      ...
      function no(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            ro()
              ? Reflect.construct(t, n || [], oo(e).constructor)
              : t.apply(e, n)
          )
        );
      }
          ...
          return (
            so(
              ...
              function (n) {
                ...
                o.setAttribute(r, ''),
                  t.A.emit('componentadd', { entity: o, component: r });
              }
            ),
            e
          );
      ...
      so(co, 'propTypes', { entity: V().object });
      const po = function () {
      ...
      function mo(e, t) {
        for (var n = 0; n < t.length; n++) {
          ...
          (r.enumerable = r.enumerable || !1),
            (r.configurable = !0),
            'value' in r && (r.writable = !0),
            Object.defineProperty(e, Co(r.key), r);
        }
      }
      function ho(e, t, n) {
        return (
          (t = go(t)),
          (function (e, t) {
            if (t && ('object' === fo(t) || 'function' == typeof t)) return t;
            if (void 0 !== t)
              throw new TypeError(
                'Derived constructors may only return object or undefined'
              );
            ...
            e,
            yo()
              ? Reflect.construct(t, n || [], go(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      var wo = (function (e) {
        function t(e) {
          ...
          return (
            ...
            Ao(bo((n = ho(this, t, [e]))), 'onChange', function (e) {
      ...
      function Oo(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            So()
              ? Reflect.construct(t, n || [], ko(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      Ao(wo, 'propTypes', {
        componentname: V().string.isRequired,
        entity: V().object,
        name: V().string.isRequired,
        onChange: V().func,
        value: V().bool
      }),
        Ao(wo, 'defaultProps', { value: !1 });
      var Po = (function (e) {
        function t(e) {
          var n;
          !(function (e, t) {
            ...
            To(Mo((n = Oo(this, t, [e]))), 'onChange', function (e) {
              n.setValue(e.target.value);
            }),
            To(Mo(n), 'onKeyUp', function (e) {
              e.stopPropagation(), n.setValue(e.target.value);
            }),
            To(Mo(n), 'onChangeText', function (e) {
              n.setState({ value: e.target.value });
            });
          var r = n.props.value;
          return (
            (n.color = new THREE.Color()),
            (n.state = { value: r, pickerValue: n.getHexString(r) }),
            n
          );
        }
        var n, r;
      ...
      To(Po, 'propTypes', {
        ...
        To(Po, 'defaultProps', { value: '#ffffff' });
      var Vo = (function (e) {
        function t(e) {
          var n;
          return (
            ...
            Fo(zo((n = Lo(this, t, [e]))), 'onChange', function (e) {
      ...
      var Ko = (function (e) {
        function t(e) {
          ...
          return (
            ...
            Xo(Zo((n = Wo(this, t, [e]))), 'onMouseMove', function (e) {
              var t = parseFloat(n.state.value),
                r = [e.clientX, e.clientY],
                o = r[0] - n.prevPointer[0] - (r[1] - n.prevPointer[1]);
              n.distance += o;
              var i =
                n.onMouseDownValue +
                ((n.distance / (e.shiftKey ? 5 : 50)) * n.props.step) / 2;
              t !== (i = Math.min(n.props.max, Math.max(n.props.min, i))) &&
                n.setValue(i),
                (n.prevPointer = [e.clientX, e.clientY]);
            }),
            Xo(Zo(n), 'onMouseDown', function (e) {
              e.preventDefault(),
                (n.distance = 0),
                (n.onMouseDownValue = n.state.value),
                (n.prevPointer = [e.clientX, e.clientY]),
                document.addEventListener('mousemove', n.onMouseMove, !1),
                document.addEventListener('mouseup', n.onMouseUp, !1);
            }),
            Xo(Zo(n), 'onMouseUp', function () {
              document.removeEventListener('mousemove', n.onMouseMove, !1),
                document.removeEventListener('mouseup', n.onMouseUp, !1),
                Math.abs(n.distance) < 2 &&
                  (n.input.current.focus(), n.input.current.select());
            }),
            Xo(Zo(n), 'onBlur', function () {
              n.setValue(parseFloat(n.input.current.value)),
                n.setState({ class: '' });
            }),
            Xo(Zo(n), 'onChange', function (e) {
              n.setState({
                value: e.target.value,
                displayValue: e.target.value
              });
            }),
            Xo(Zo(n), 'onKeyDown', function (e) {
              if ((e.stopPropagation(), 13 === e.keyCode))
                return (
                  n.setValue(parseFloat(n.input.current.value)),
                  void n.input.current.blur()
                );
              38 !== e.keyCode
                ? 40 !== e.keyCode ||
                  n.setValue(parseFloat(n.state.value) - 0.01)
                : n.setValue(parseFloat(n.state.value) + 0.01);
            }),
            (n.state = {
              value: n.props.value,
              displayValue:
                'number' == typeof n.props.value
                  ? n.props.value.toFixed(n.props.precision)
                  : ''
            }),
            (n.input = O.createRef()),
            n
        ...
        return (
          ...
          (r = [
            ...
            },
            {
              ...
              value: function (e) {
                e !== this.state.value &&
                  ...
                  isNaN(e) && (e = this.props.value),
                  e < this.props.min && (e = this.props.min),
            ...
            },
            {
              key: 'componentDidUpdate',
              value: function (e) {
                Object.is(this.props.value, e.value) ||
                  this.setState({
                    value: this.props.value,
      ...
      function ei(e, t) {
        for (var n = 0; n < t.length; n++) {
          ...
          (r.enumerable = r.enumerable || !1),
            (r.configurable = !0),
            'value' in r && (r.writable = !0),
            Object.defineProperty(e, si(r.key), r);
        }
      }
      function ti(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            ni()
              ? Reflect.construct(t, n || [], ri(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      var li = (function (e) {
        function t(e) {
          ...
          !(function (e, t) {
            ...
            ai(oi((n = ti(this, t, [e]))), 'onChange', function (e) {
              n.setState({ value: e }, function () {
                n.props.onChange && n.props.onChange(n.props.name, e.value);
              });
            });
          var r = n.props.value || '';
          return (n.state = { value: { value: r, label: r } }), n;
        }
        var n, r;
        return (
          (function (e, t) {
      ...
      function ui(e, t) {
        for (var n = 0; n < t.length; n++) {
          ...
          (r.enumerable = r.enumerable || !1),
            (r.configurable = !0),
            'value' in r && (r.writable = !0),
            Object.defineProperty(e, gi(r.key), r);
        }
      }
      function pi(e, t, n) {
        return (
      ...
      var bi = (function (e) {
        function n(e) {
          ...
          return (
            ...
            yi(mi((r = pi(this, n, [e]))), 'notifyChanged', function (e) {
              r.props.onChange && r.props.onChange(r.props.name, e),
                r.setState({ value: e });
            }),
            yi(mi(r), 'onChange', function (e) {
              var t = e.target.value;
              r.setState({ value: t }), r.notifyChanged(t);
            }),
            yi(mi(r), 'removeMap', function () {
              r.setValue(''), r.notifyChanged('');
            }),
            yi(mi(r), 'openDialog', function () {
              t.A.emit('opentexturesmodal', r.state.value, function (e) {
                if (e) {
                  var t = e.value;
                  'asset' !== e.type &&
                    (t =
                    ...
                    r.props.onChange && r.props.onChange(r.props.name, t),
                    r.setValue(t);
                }
              });
            }),
            (r.state = { value: r.props.value || '' }),
            (r.canvas = O.createRef()),
            r
          );
        }
        var r, o;
            ...
            },
            {
              ...
              value: function (e) {
                ...
                var i,
                  ...
                  l = e instanceof HTMLVideoElement,
                  c = s || l;
                t = c
                  ? e.src
                  : a
      ...
      yi(bi, 'propTypes', {
        ...
        name: V().string.isRequired,
        onChange: V().func,
        value: V().oneOfType([V().object, V().string])
      }),
        yi(bi, 'defaultProps', { value: '', mapName: 'nomap', dataURL: '' });
      var Ti = (function (e) {
        function t(e) {
          var n;
          return (
            ...
            Mi(Si((n = xi(this, t, [e]))), 'onChange', function (e, t) {
              n.setState(Mi({}, e, parseFloat(t.toFixed(5))), function () {
                n.props.onChange && n.props.onChange(e, n.state);
              });
            }),
            (n.state = {
              x: e.value.x,
            ...
            },
            {
              ...
              value: function () {
                ...
                return (0, U.jsxs)('div', {
                  className: 'vec4',
                  children: [
                    (0, U.jsx)(Ko, Ci({ name: 'x', value: this.state.x }, e)),
                    (0, U.jsx)(Ko, Ci({ name: 'y', value: this.state.y }, e)),
                    (0, U.jsx)(Ko, Ci({ name: 'z', value: this.state.z }, e)),
                    (0, U.jsx)(Ko, Ci({ name: 'w', value: this.state.w }, e))
                  ]
                });
              }
            }
      ...
      function Ni(e, t) {
        for (var n = 0; n < t.length; n++) {
          ...
          (r.enumerable = r.enumerable || !1),
            (r.configurable = !0),
            'value' in r && (r.writable = !0),
            Object.defineProperty(e, Hi(r.key), r);
        }
      }
      function Li(e, t, n) {
        return (
      ...
      var Vi = (function (e) {
        function t(e) {
          ...
          return (
            ...
            Fi(zi((n = Li(this, t, [e]))), 'onChange', function (e, t) {
              n.setState(Fi({}, e, parseFloat(t.toFixed(5))), function () {
                n.props.onChange && n.props.onChange(e, n.state);
              });
            }),
            (n.state = { x: e.value.x, y: e.value.y, z: e.value.z }),
            n
          );
        }
        var n, r;
            ...
            },
            {
              ...
              value: function () {
                ...
                return (0, U.jsxs)('div', {
                  className: 'vec3',
                  children: [
                    (0, U.jsx)(Ko, Ri({ name: 'x', value: this.state.x }, e)),
                    (0, U.jsx)(Ko, Ri({ name: 'y', value: this.state.y }, e)),
                    (0, U.jsx)(Ko, Ri({ name: 'z', value: this.state.z }, e))
                  ]
                });
              }
            }
      ...
      var ea = (function (e) {
        function t(e) {
          ...
          return (
            ...
            Ki(Xi((n = Gi(this, t, [e]))), 'onChange', function (e, t) {
              n.setState(Ki({}, e, parseFloat(t.toFixed(5))), function () {
                n.props.onChange && n.props.onChange(e, n.state);
              });
            }),
            (n.state = { x: e.value.x, y: e.value.y }),
            n
          );
        }
        var n, r;
            ...
            },
            {
              ...
              value: function () {
                ...
                return (0, U.jsxs)('div', {
                  className: 'vec2',
                  children: [
                    (0, U.jsx)(Ko, Wi({ name: 'x', value: this.state.x }, e)),
                    (0, U.jsx)(Ko, Wi({ name: 'y', value: this.state.y }, e))
                  ]
                });
              }
            }
      ...
      function oa(e, t) {
        for (var n = 0; n < t.length; n++) {
          ...
          (r.enumerable = r.enumerable || !1),
            (r.configurable = !0),
            'value' in r && (r.writable = !0),
            Object.defineProperty(e, ua(r.key), r);
        }
      }
      function ia(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            aa()
              ? Reflect.construct(t, n || [], sa(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      var pa = (function (e) {
        function t(e) {
          ...
          return (
            ...
            ((n = ia(this, t, [e])).id = e.componentname + ':' + e.name),
            n
          );
        }
        var n, r;
          ...
          (r = [
            {
              ...
              value: function () {
                ...
                if (e.schema.oneOf && e.schema.oneOf.length > 0)
                  return (0, U.jsx)(
                    li,
                    ra(ra({}, o), {}, { options: e.schema.oneOf })
                  );
                if ('map' === n || t) return (0, U.jsx)(bi, ra({}, o));
                switch (n) {
                  case 'number':
                    return (0, U.jsx)(Ko, ra(ra({}, o), i));
                  case 'int':
                    return (0, U.jsx)(
                      Ko,
                      ra(ra(ra({}, o), i), {}, { precision: 0 })
                    );
                  case 'vec2':
                    return (0, U.jsx)(ea, ra({}, o));
                  case 'vec3':
                    return (0, U.jsx)(Vi, ra({}, o));
                  case 'vec4':
                    return (0, U.jsx)(Ti, ra({}, o));
                  case 'color':
                    return (0, U.jsx)(Po, ra({}, o));
                  case 'boolean':
                    return (0, U.jsx)(wo, ra({}, o));
                  default:
                    return (0, U.jsx)(Vo, ra({}, o));
                }
              }
            },
            {
      ...
      function da(e, t) {
        for (var n = 0; n < t.length; n++) {
          ...
          (r.enumerable = r.enumerable || !1),
            (r.configurable = !0),
            'value' in r && (r.writable = !0),
            Object.defineProperty(e, Aa(r.key), r);
        }
      }
      function ma(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            ha()
              ? Reflect.construct(t, n || [], ya(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      ca(pa, 'propTypes', {
        ...
        entity: V().object.isRequired,
        id: V().string,
        isSingle: V().bool.isRequired,
        name: V().string.isRequired,
        schema: V().object.isRequired
      });
      var Ca = (function (e) {
        function t(e) {
          var n;
          return (
            ...
            va(ga((n = ma(this, t, [e]))), 'toggleVisibility', function (e) {
              'A' !== e.target.nodeName &&
                n.setState({ collapsed: !n.state.collapsed });
            }),
            (n.state = { collapsed: n.props.collapsed }),
            n
          );
        }
        var n, r;
          ...
          (r = [
            {
              ...
              value: function () {
                ...
                var t = po(e),
                  n = po({ content: !0, hide: this.state.collapsed });
                return (0, U.jsxs)('div', {
                  id: this.props.id,
                  className: t,
                  children: [
                    (0, U.jsxs)('div', {
                      ...
                      children: [
                        (0, U.jsx)('div', { className: 'collapse-button' }),
      ...
      va(Ca, 'propTypes', {
        className: V().string,
        collapsed: V().bool,
        children: V().oneOfType([V().array, V().element]).isRequired,
        id: V().string
      }),
        va(Ca, 'defaultProps', { collapsed: !1 });
      var wa = o(673),
        xa = o.n(wa);
      function Ea(e) {
        return (
      ...
      function Sa(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            ka()
              ? Reflect.construct(t, n || [], Ma(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      var Ra = AFRAME.schema.isSingleProperty,
        Na = (function (e) {
          function n(e) {
            var r;
            return (
              ...
              Ia(ja((r = Sa(this, n, [e]))), 'removeComponent', function (e) {
                var n = r.props.name;
                e.stopPropagation(),
                  confirm(
                    'Do you really want to remove component `' + n + '`?'
                  ) &&
                    (r.props.entity.removeAttribute(n),
                    t.A.emit('componentremove', {
                      entity: r.props.entity,
                      component: n
                    }));
              }),
              Ia(ja(r), 'renderPropertyRows', function () {
                var e = r.props.component;
                if (Ra(e.schema)) {
                  var t = r.props.name,
                    n = AFRAME.components[t.split('__')[0]].schema;
                  return (0, U.jsx)(
                    pa,
                    {
                      name: t,
              ...
              (r.state = { entity: r.props.entity, name: r.props.name }),
              r
            );
          }
          var r, o, i;
                            ...
                            (0, U.jsxs)('div', {
                              ...
                              children: [
                                (0, U.jsx)('a', {
                                  ...
                                  children: (0, U.jsx)(ee, { icon: T })
                                }),
                                (0, U.jsx)('a', {
                                  title: 'Remove component',
                                  className: 'button',
                                  onClick: this.removeComponent,
                                  children: (0, U.jsx)(ee, { icon: k })
                                })
                              ]
                            })
                          ]
      ...
      const La = ['visible', 'position', 'scale', 'rotation'];
      function _a(e) {
        return (
          (_a =
            'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator
      ...
      function za(e, t, n) {
        return (
          (t = Fa(t)),
          (function (e, t) {
            if (t && ('object' === _a(t) || 'function' == typeof t)) return t;
            if (void 0 !== t)
              throw new TypeError(
                'Derived constructors may only return object or undefined'
              );
            ...
            e,
            Da()
              ? Reflect.construct(t, n || [], Fa(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      var Wa = (function (e) {
        function n(e) {
          ...
          return (
            ...
            Ua(Ha((r = za(this, n, [e]))), 'getMixinOptions', function () {
              var e = r.props.entity.mixinEls.map(function (e) {
                return e.id;
              });
            ...
            Ua(Ha(r), 'updateMixins', function (e) {
              var n = r.props.entity;
              r.setState({ mixins: e });
              var o = e
                .map(function (e) {
                  return e.value;
            ...
            (r.state = { mixins: r.getMixinValue() }),
            r
          );
        }
        var r, o;
      ...
      function Za(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            $a()
              ? Reflect.construct(t, n || [], Xa(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      Ua(Wa, 'propTypes', { entity: V().object.isRequired });
      var Ja = {
          camera: (0, U.jsx)('i', {
            title: 'camera',
            children: (0, U.jsx)(ee, {
            ...
            (r = [
              {
                ...
                value: function () {
                  var e = this.props.entity,
                    t = this.props.onDoubleClick;
                  if (!e) return null;
                  var n = [];
                  for (var r in Ja)
                    e.getObject3D(r) &&
                      n.push(
                        (0, U.jsxs)('span', { children: [' ', Ja[r]] }, r)
                      );
                  var o = e.id,
                    i = 'id';
                  return (
                    e.isScene || o || !e.getAttribute('class')
                      ? e.isScene ||
                        ...
                        ((o = e.getAttribute('mixin').split(' ')[0]),
                        (i = 'mixin'))
                      : ((o = e.getAttribute('class').split(' ')[0]),
                        (i = 'class')),
                    (0, U.jsxs)('span', {
      ...
      !(function (e, t, n) {
        (t = Ka(t)) in e
          ...
          : (e[t] = n);
      })(es, 'propTypes', { entity: V().object, onDoubleClick: V().func });
      function ts(e) {
        return (
          (ts =
            'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator
      ...
      function rs(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            os()
              ? Reflect.construct(t, n || [], is(e).constructor)
              : t.apply(e, n)
          )
        );
      }
        ...
        return (
          ...
          (o = [
            ...
            },
            {
              ...
              value: function () {
                var e = this.props.entity;
                return ['position'].map(function (t) {
              ...
              value: function () {
                return this.props.entity
                  ? (0, U.jsxs)(Ca, {
                      ...
                      children: [
                        (0, U.jsx)('div', { className: 'collapsible-header' }),
                        (0, U.jsxs)('div', {
                          className: 'collapsible-content',
                          children: [
                            (0, U.jsx)('div', {
      ...
      function ps(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            fs()
              ? Reflect.construct(t, n || [], ds(e).constructor)
              : t.apply(e, n)
          )
        );
      }
            ...
            },
            {
              ...
              value: function () {
                ...
                return (0, U.jsxs)('div', {
                  ...
                  children: [(0, U.jsx)(ls, { entity: e }), r]
                });
              }
            }
          ]),
      ...
      function vs(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            As()
              ? Reflect.construct(t, n || [], Cs(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      var Ss = (function (e) {
        function n(e) {
          ...
          return (
            ...
            Es(ws((t = vs(this, n, [e]))), 'handleToggle', function () {
          ...
          (o = [
            {
              ...
              value: function () {
                var e = this;
                t.A.on('componentremove', function (t) {
                  e.forceUpdate();
                }),
                  t.A.on('componentadd', function (t) {
                    e.forceUpdate();
                  });
              }
            },
      ...
      Es(Ss, 'propTypes', { entity: V().object, visible: V().bool });
      var _s = (function (e) {
        function t(e) {
          var n;
          return (
            ...
            Ns(Ps((n = js(this, t, [e]))), 'handleGlobalKeydown', function (e) {
              n.state.isOpen &&
                (27 === e.keyCode ||
                  (n.props.extraCloseKeyCode &&
                    e.keyCode === n.props.extraCloseKeyCode)) &&
                (n.close(), e.stopPropagation());
            }),
            Ns(Ps(n), 'shouldClickDismiss', function (e) {
              var t = e.target;
              return (
                ('INPUT' !== t.tagName || 'file' !== t.type) &&
                t !== n.self.current &&
                !n.self.current.contains(t)
              );
            }),
            Ns(Ps(n), 'handleGlobalMousedown', function (e) {
              n.props.closeOnClickOutside &&
                n.state.isOpen &&
                n.shouldClickDismiss(e) &&
                'function' == typeof n.props.onClose &&
                n.props.onClose();
            }),
            Ns(Ps(n), 'close', function () {
              n.setState({ isOpen: !1 }), n.props.onClose && n.props.onClose();
            }),
            (n.state = { isOpen: n.props.isOpen }),
            (n.self = O.createRef()),
            n
          );
        }
                    ...
                    children: [
                      (0, U.jsxs)('div', {
                        ...
                        children: [
                          ...
                          (0, U.jsx)('h3', { children: this.props.title })
                        ]
                      }),
                      (0, U.jsx)('div', {
      ...
      function Ds(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            Fs()
              ? Reflect.construct(t, n || [], Hs(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      Ns(_s, 'propTypes', {
        ...
        children: V().oneOfType([V().array, V().element]).isRequired,
        isOpen: V().bool,
        extraCloseKeyCode: V().number,
        closeOnClickOutside: V().bool,
        onClose: V().func,
        title: V().string
      }),
        Ns(_s, 'defaultProps', { closeOnClickOutside: !0 });
      var Zs = (function (e) {
        function n(e) {
          var t;
          return (
            ...
            Ys(Vs((t = Ds(this, n, [e]))), 'onClose', function (e) {
              t.props.onClose && t.props.onClose();
            }),
            Ys(Vs(t), 'selectTexture', function (e) {
              t.props.onClose && t.props.onClose(e);
            }),
            Ys(Vs(t), 'generateFromRegistry', function () {
              var e = Vs(t);
            ...
            Ys(Vs(t), 'generateFromAssets', function () {
            ...
            Ys(Vs(t), 'onChangeFilter', function (e) {
          ...
          (o = [
            {
              ...
              value: function () {
                var e = this;
                t.A.on('assetsimagesload', function (t) {
            ...
            },
            {
              key: 'isValidAsset',
              value: function () {
                var e = Gs(this.state.preview.name);
                        ...
                        children: [
                          ...
                          (0, U.jsxs)('div', {
                            ...
                            children: [
                              ...
                              (0, U.jsx)('span', { children: Qs(e.src) }),
                              (0, U.jsxs)('span', {
      ...
      function qs(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            Ks()
              ? Reflect.construct(t, n || [], Js(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      var ol = (function (e) {
        function t(e) {
          ...
          return (
            ...
            nl(el((n = qs(this, t, [e]))), 'onClose', function () {
      ...
      function sl(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            ll()
              ? Reflect.construct(t, n || [], cl(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      function dl(e) {
        ...
        return 'symbol' == il(t) ? t : String(t);
      }
      nl(ol, 'propTypes', { isOpen: V().bool, onClose: V().func });
      var ml = (function (e) {
        function n(e) {
          var r;
          return (
            ...
            fl(ul((r = sl(this, n, [e]))), 'onClick', function () {
              return r.props.selectEntity(r.props.entity);
            }),
            fl(ul(r), 'onDoubleClick', function () {
              return t.A.emit('objectfocus', r.props.entity.object3D);
            }),
            fl(ul(r), 'toggleVisibility', function () {
              var e = r.props.entity,
                t =
              ...
              value: function () {
                ...
                e =
                  o.children.length > 0 && !n
                    ...
                    : (0, U.jsx)('span', { className: 'collapsespace' });
                var c =
                    'a-scene' === i
                      ? o.object3D.visible
      ...
      function gl(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            bl()
              ? Reflect.construct(t, n || [], vl(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      fl(ml, 'propTypes', {
        ...
        isSelected: V().bool,
        selectEntity: V().func,
        toggleExpandedCollapsed: V().func
      });
      var Ol = (function (e) {
        function n(e) {
          var t;
          return (
            ...
            wl(Al((t = gl(this, n, [e]))), 'writeChanges', function () {
            ...
            wl(Al(t), 'toggleScenePlaying', function () {
      ...
      function jl(e, t) {
        for (var n = 0; n < t.length; n++) {
          ...
          (r.enumerable = r.enumerable || !1),
            (r.configurable = !0),
            'value' in r && (r.writable = !0),
            Object.defineProperty(e, _l(r.key), r);
        }
      }
      function Tl(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            Il()
              ? Reflect.construct(t, n || [], Pl(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      var Bl = (function (e) {
        function n(e) {
          ...
          return (
            ...
            Ll(Rl((o = Tl(this, n, [e]))), 'selectEntity', function (e) {
              for (var n = !1, r = 0; r < o.state.filteredEntities.length; r++)
                o.state.filteredEntities[r].entity === e &&
                  (o.setState({ selectedEntity: e, selectedIndex: r }),
                  o.expandToRoot(e),
                  o.props.onChange && o.props.onChange(e),
                  t.A.emit('entityselect', e, !0),
                  (n = !0));
              n || o.setState({ selectedEntity: null, selectedIndex: -1 });
            }),
            Ll(Rl(o), 'rebuildEntityOptions', function () {
              var e = [{ depth: 0, entity: o.props.scene }];
              !(function t(n, r) {
                if (n) {
                  r += 1;
                ...
                o.setState({
                  entities: e,
                  filteredEntities: o.getFilteredEntities(o.state.filter, e)
                });
            }),
            Ll(Rl(o), 'selectIndex', function (e) {
              e >= 0 &&
                e < o.state.entities.length &&
                o.selectEntity(o.state.entities[e].entity);
            }),
            Ll(Rl(o), 'onFilterKeyUp', function (e) {
              27 === e.keyCode && o.clearFilter();
            }),
            Ll(Rl(o), 'onKeyDown', function (e) {
              switch (e.keyCode) {
                case 37:
                case 38:
                case 39:
            ...
            Ll(Rl(o), 'onKeyUp', function (e) {
              if (null !== o.props.selectedEntity)
                switch (e.keyCode) {
                  case 37:
                    o.isExpanded(o.props.selectedEntity) &&
                      o.toggleExpandedCollapsed(o.props.selectedEntity);
                    break;
                  case 38:
                    o.selectIndex(
                      o.previousExpandedIndexTo(o.state.selectedIndex)
                    );
                    break;
                  case 39:
                    o.isExpanded(o.props.selectedEntity) ||
                    ...
                    break;
                  case 40:
                    o.selectIndex(o.nextExpandedIndexTo(o.state.selectedIndex));
                }
            }),
            Ll(Rl(o), 'isVisibleInSceneGraph', function (e) {
              var t = e.parentNode;
              if (!t) return !1;
              for (; void 0 !== t && t.isEntity; ) {
                if (!o.isExpanded(t)) return !1;
                t = t.parentNode;
              }
              return !0;
            }),
            Ll(Rl(o), 'isExpanded', function (e) {
              return !0 === o.state.expandedElements.get(e);
            }),
            Ll(Rl(o), 'toggleExpandedCollapsed', function (e) {
              o.setState({
                expandedElements: o.state.expandedElements.set(
                  e,
                  !o.isExpanded(e)
                )
              });
            }),
            Ll(Rl(o), 'expandToRoot', function (e) {
              for (var t = e.parentNode; void 0 !== t && t.isEntity; )
                o.state.expandedElements.set(t, !0), (t = t.parentNode);
              o.setState({ expandedElements: o.state.expandedElements });
            }),
            Ll(Rl(o), 'previousExpandedIndexTo', function (e) {
              for (var t = e - 1; t >= 0; t--) {
                var n = o.state.entities[t].entity;
                if (o.isVisibleInSceneGraph(n)) return t;
              }
              return -1;
            }),
            Ll(Rl(o), 'nextExpandedIndexTo', function (e) {
              for (var t = e + 1; t < o.state.entities.length; t++) {
                var n = o.state.entities[t].entity;
                if (o.isVisibleInSceneGraph(n)) return t;
              }
              return -1;
            }),
            Ll(Rl(o), 'onChangeFilter', function (e) {
              var t = e.target.value;
              o.setState({ filter: t }), o.updateFilteredEntities(t);
            }),
            Ll(Rl(o), 'clearFilter', function () {
              o.setState({ filter: '' }), o.updateFilteredEntities('');
            }),
            Ll(Rl(o), 'renderEntities', function () {
              return o.state.filteredEntities.map(function (e, t) {
                return o.isVisibleInSceneGraph(e.entity) || o.state.filter
                  ? (0, O.createElement)(
                      ml,
                      Ml(
                        Ml({}, e),
                        ...
                        {
                          key: t,
                          isFiltering: !!o.state.filter,
                          isExpanded: o.isExpanded(e.entity),
                          isSelected: o.props.selectedEntity === e.entity,
                          selectEntity: o.selectEntity,
                          toggleExpandedCollapsed: o.toggleExpandedCollapsed
                        }
                      )
                    )
                  : null;
            ...
            (o.rebuildEntityOptions = r()(
              o.rebuildEntityOptions.bind(Rl(o)),
              1e3
            )),
            (o.updateFilteredEntities = r()(
              o.updateFilteredEntities.bind(Rl(o)),
              500
            )),
            o
          );
          ...
          (i = [
            {
              ...
              value: function () {
                ...
                this.rebuildEntityOptions(),
                  t.A.on('entityidchange', this.rebuildEntityOptions),
                  t.A.on('entitycreated', this.rebuildEntityOptions),
                  t.A.on('entityclone', this.rebuildEntityOptions),
                  t.A.on('entityupdate', function (t) {
                    'mixin' === t.component && e.rebuildEntityOptions();
                  });
              }
            },
            {
                      ...
                      children: [
                        ...
                        (0, U.jsxs)('div', {
                          ...
                          children: [
                            ...
                            e,
                            !this.state.filter && (0, U.jsx)(ee, { icon: B })
                          ]
                        })
                      ]
                    }),
      ...
      function Dl(e, t) {
        for (var n = 0; n < t.length; n++) {
          ...
          (r.enumerable = r.enumerable || !1),
            (r.configurable = !0),
            'value' in r && (r.writable = !0),
            Object.defineProperty(e, Fl(r.key), r);
        }
      }
      function Fl(e) {
        var t = (function (e, t) {
      ...
      function Hl(e, t, n) {
        return (
          (t = Ul(t)),
          (function (e, t) {
            if (t && ('object' === zl(t) || 'function' == typeof t)) return t;
            if (void 0 !== t)
              throw new TypeError(
                'Derived constructors may only return object or undefined'
              );
            ...
            e,
            Vl()
              ? Reflect.construct(t, n || [], Ul(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      var Gl = (function (e) {
        function n(e) {
          ...
          return (
            ...
            ((t = Hl(this, n, [e])).state = { selectedCamera: 'perspective' }),
          ...
          (o = [
            {
              ...
              value: function () {
                var e = this;
                t.A.on('cameratoggle', function (t) {
                  e.justChangedCamera
              ...
              value: function () {
                return (0, U.jsx)('div', {
                  ...
                  children: (0, U.jsx)(Jr, {
                    ...
                    options: Wl,
                    simpleValue: !0,
                    value: Ql(this.state.selectedCamera),
                    isSearchable: !1,
      ...
      function Xl(e, t, n) {
        return (
          ...
          (function (e, t) {
            ...
            e,
            ql()
              ? Reflect.construct(t, n || [], Kl(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      var rc = [
          { value: 'translate', icon: (0, U.jsx)(ee, { icon: P }) },
          {
            value: 'rotate',
            icon: (0, U.jsx)(ee, {
              icon: {
          ...
          function n(e) {
            ...
            return (
              ...
              tc(
                ...
                'changeTransformMode',
                function (e) {
                  r.setState({ selectedTransform: e }),
                    t.A.emit('transformmodechange', e);
                }
              ),
              tc(Jl(r), 'onLocalChange', function (e) {
                var n = e.target.checked;
                r.setState({ localSpace: n }),
                  t.A.emit('transformspacechanged', n ? 'local' : 'world');
              }),
              tc(Jl(r), 'renderTransformButtons', function () {
                return rc.map(
                  function (e, t) {
                    var n = e.value === this.state.selectedTransform,
                      r = po({ button: !0, active: n });
                    return (0, U.jsx)(
                      'a',
                      {
                        title: e.value,
              ...
              (r.state = { selectedTransform: 'translate', localSpace: !1 }),
              r
            );
          }
          var r, o;
            ...
            (o = [
              {
                ...
                value: function () {
                  var e = this;
                  t.A.on('transformmodechange', function (t) {
                    e.setState({ selectedTransform: t });
                  }),
                    t.A.on('transformspacechange', function () {
                      t.A.emit(
      ...
      function ac(e, t) {
        for (var n = 0; n < t.length; n++) {
          ...
          (r.enumerable = r.enumerable || !1),
            (r.configurable = !0),
            'value' in r && (r.writable = !0),
            Object.defineProperty(e, sc(r.key), r);
        }
      }
      function sc(e) {
        var t = (function (e, t) {
      ...
      function lc(e, t, n) {
        return (
          (t = uc(t)),
          (function (e, t) {
            if (t && ('object' === ic(t) || 'function' == typeof t)) return t;
            if (void 0 !== t)
              throw new TypeError(
                'Derived constructors may only return object or undefined'
              );
            ...
            e,
            cc()
              ? Reflect.construct(t, n || [], uc(e).constructor)
              : t.apply(e, n)
          )
        );
      }
          ...
          (o = [
            {
              ...
              value: function () {
                var e = this;
                t.A.on('raycastermouseenter', function (t) {
                  e.setState({ hoveredEntity: t });
                }),
                  t.A.on('raycastermouseleave', function (t) {
                    e.setState({ hoveredEntity: t });
                  });
              }
            },
            {
              key: 'render',
              value: function () {
                return (0, U.jsx)('div', { id: 'viewportHud' });
              }
            }
          ]) && ac(r.prototype, o),
          Object.defineProperty(r, 'prototype', { writable: !1 }),
      ...
      function gc(e, t, n) {
        return (
          (t = vc(t)),
          (function (e, t) {
            if (t && ('object' === dc(t) || 'function' == typeof t)) return t;
            if (void 0 !== t)
              throw new TypeError(
                'Derived constructors may only return object or undefined'
              );
            ...
            e,
            bc()
              ? Reflect.construct(t, n || [], vc(e).constructor)
              : t.apply(e, n)
          )
        );
      }
      ...
      var Ec = (function (e) {
          function n(e) {
            ...
            return (
              ...
              wc(Ac((r = gc(this, n, [e]))), 'onCloseHelpModal', function (e) {
                r.setState({ isHelpOpen: !1 });
              }),
              wc(Ac(r), 'onModalTextureOnClose', function (e) {
                r.setState({ isModalTexturesOpen: !1 }),
                  r.state.textureOnClose && r.state.textureOnClose(e);
              }),
              wc(Ac(r), 'toggleEdit', function () {
                r.state.inspectorEnabled
              ...
              (r.state = {
                ...
                visible: { scenegraph: !1, attributes: !0 }
              }),
              t.A.on('togglesidebar', function (e) {
                'all' === e.which
                  ? r.state.visible.scenegraph || r.state.visible.attributes
                    ? r.setState({
            ...
            (o = [
              {
                ...
                value: function () {
                  ...
                  t.A.on(
                    ...
                    t.A.on('entityselect', function (t) {
                      e.setState({ entity: t });
                    }),
                    t.A.on('inspectortoggle', function (t) {
                      e.setState({ inspectorEnabled: t });
                    }),
                    t.A.on('openhelpmodal', function () {
                ...
                value: function () {
                  return this.state.inspectorEnabled &&
                    ...
                    ? (0, U.jsx)('div', {
                        ...
                        children: (0, U.jsx)('a', {
                          onClick: function () {
                            t.A.emit('togglesidebar', { which: 'attributes' });
                          },
                ...
                value: function () {
                  return !this.state.inspectorEnabled ||
                    ...
                    : (0, U.jsx)('div', {
                        ...
                        children: (0, U.jsx)('a', {
                          onClick: function () {
                            t.A.emit('togglesidebar', { which: 'scenegraph' });
                          },
                  ...
                  return (
                    ...
                    (0, U.jsxs)('div', {
                      children: [
                        ...
                        (0, U.jsx)('a', {
                          className: 'download-waypoints',
                          children: 'Download Waypoints'
                        }),
                        this.renderComponentsToggle(),
                        (0, U.jsxs)('div', {
                          id: 'inspectorContainer',
                          className: this.state.inspectorEnabled
                            ? ''
                            : 'hidden',
                          children: [
                            (0, U.jsx)(Bl, {
      ...
      const Mc = THREE;
      let jc, Tc, Ic, Pc;
      function Rc(e, t = 1 / 0, n = null) {
        Tc || (Tc = new Mc.PlaneGeometry(2, 2, 1, 1)),
          Ic ||
            (Ic = new Mc.ShaderMaterial({
              uniforms: { blitTexture: new Mc.Uniform(e) },
              vertexShader:
                '\n\t\t\tvarying vec2 vUv;\n\t\t\tvoid main(){\n\t\t\t\tvUv = uv;\n\t\t\t\tgl_Position = vec4(position.xy * 1.0,0.,.999999);\n\t\t\t}',
              fragmentShader:
                '\n\t\t\tuniform sampler2D blitTexture; \n\t\t\tvarying vec2 vUv;\n\n\t\t\tvoid main(){ \n\t\t\t\tgl_FragColor = vec4(vUv.xy, 0, 1);\n\t\t\t\t\n\t\t\t\t#ifdef IS_SRGB\n\t\t\t\tgl_FragColor = LinearTosRGB( texture2D( blitTexture, vUv) );\n\t\t\t\t#else\n\t\t\t\tgl_FragColor = texture2D( blitTexture, vUv);\n\t\t\t\t#endif\n\t\t\t}'
            })),
          (Ic.uniforms.blitTexture.value = e),
          (Ic.defines.IS_SRGB = e.colorSpace == Mc.SRGBColorSpace),
          (Ic.needsUpdate = !0),
          Pc || ((Pc = new Mc.Mesh(Tc, Ic)), (Pc.frustrumCulled = !1));
        const r = new Mc.PerspectiveCamera(),
          o = new Mc.Scene();
        o.add(Pc),
          null === n && (n = jc = new Mc.WebGLRenderer({ antialias: !1 }));
        const i = Math.min(e.image.width, t),
          a = Math.min(e.image.height, t);
        n.setSize(i, a), n.clear(), n.render(o, r);
        const s = document.createElement('canvas'),
          l = s.getContext('2d');
        (s.width = i), (s.height = a), l.drawImage(n.domElement, 0, 0, i, a);
        const c = new Mc.CanvasTexture(s);
        return (
          (c.minFilter = e.minFilter),
          (c.magFilter = e.magFilter),
          (c.wrapS = e.wrapS),
          (c.wrapT = e.wrapT),
          (c.name = e.name),
          jc && (jc.forceContextLoss(), jc.dispose(), (jc = null)),
          c
        );
      }
      const Nc = {
      ...
      const _c = 5120,
        ...
        zc = 5122,
        Dc = 5123,
        Fc = 'KHR_mesh_quantization',
        Hc = {};
      (Hc[Mc.NearestFilter] = 9728),
        (Hc[Mc.NearestMipmapNearestFilter] = 9984),
        (Hc[Mc.NearestMipmapLinearFilter] = 9986),
        (Hc[Mc.LinearFilter] = 9729),
        (Hc[Mc.LinearMipmapNearestFilter] = 9985),
        (Hc[Mc.LinearMipmapLinearFilter] = 9987),
        (Hc[Mc.ClampToEdgeWrapping] = 33071),
        (Hc[Mc.RepeatWrapping] = 10497),
        (Hc[Mc.MirroredRepeatWrapping] = 33648);
      const Vc = {
          scale: 'scale',
      ...
      class $c {
        ...
        async write(e, t, n = {}) {
          ...
          const a = r.extensionsUsed,
            ...
            l = new Blob(o, { type: 'application/octet-stream' }),
            c = Object.keys(a),
            u = Object.keys(s);
          if (
            (c.length > 0 && (i.extensionsUsed = c),
            u.length > 0 && (i.extensionsRequired = u),
            i.buffers &&
              i.buffers.length > 0 &&
              (i.buffers[0].byteLength = l.size),
            !0 === n.binary)
          ) {
        ...
        buildMetalRoughTexture(e, t) {
          if (e === t) return e;
          function n(e) {
            return e.colorSpace === Mc.SRGBColorSpace
              ? function (e) {
                  return e < 0.04045
                    ? 0.0773993808 * e
          ...
          console.warn(
            ...
            e instanceof Mc.CompressedTexture && (e = Rc(e)),
            t instanceof Mc.CompressedTexture && (t = Rc(t));
          ...
          const u = (e || t).clone();
          return (
            (u.source = new Mc.Source(s)),
            (u.colorSpace = Mc.NoColorSpace),
            (u.channel = (e || t).channel),
            e &&
              t &&
              e.channel !== t.channel &&
              console.warn(
                ...
                : (0 === n
                    ...
                    : 1 === n
                      ...
                      : 2 === n
                        ...
                        : 3 === n && (r = e.getW(o)),
                  !0 === e.normalized &&
                    (r = Mc.MathUtils.normalize(r, e.array))),
                5126 === t
                  ? l.setFloat32(c, r, !0)
                  : 5124 === t
                    ? l.setInt32(c, r, !0)
        ...
        processAccessor(e, t, n, r) {
          ...
          else if (e.array.constructor === Int32Array) i = 5124;
          else if (e.array.constructor === Uint32Array) i = 5125;
          else if (e.array.constructor === Int16Array) i = zc;
          else if (e.array.constructor === Uint16Array) i = Dc;
          else if (e.array.constructor === Int8Array) i = _c;
          else {
                  ...
                  : (0 === t
                      ...
                      : 1 === t
                        ...
                        : 2 === t
                          ...
                          : 3 === t && (n = e.getW(o)),
                    !0 === e.normalized &&
                      (n = Mc.MathUtils.normalize(n, e.array))),
        ...
        processSampler(e) {
          ...
          const n = {
            magFilter: Hc[e.magFilter],
            minFilter: Hc[e.minFilter],
            wrapS: Hc[e.wrapS],
            wrapT: Hc[e.wrapT]
          };
        ...
        processTexture(e) {
          ...
          r.textures || (r.textures = []),
            e instanceof Mc.CompressedTexture && (e = Rc(e, t.maxTextureSize));
        ...
        processMaterial(e) {
          ...
          if (
            ...
            const t = this.buildMetalRoughTexture(
              ...
              n = { index: this.processTexture(t), channel: t.channel };
          ...
          e.transparent
            ...
            e.side === Mc.DoubleSide && (r.doubleSided = !0),
        ...
        processMesh(e) {
          ...
          for (let e in i.attributes) {
            ...
            null !== o &&
              (e.startsWith('_') || this.detectMeshQuantization(e, n),
              (l[e] = o),
              t.attributes.set(this.getUID(n), o));
          }
          if (
            ...
            for (let a = 0; a < e.morphTargetInfluences.length; ++a) {
              ...
              for (const e in i.morphAttributes) {
                ...
                if (!i.morphTargetsRelative)
                  for (let e = 0, t = n.count; e < t; e++)
                    for (let t = 0; t < n.itemSize; t++)
                      0 === t && c.setX(e, n.getX(e) - o.getX(e)),
                        1 === t && c.setY(e, n.getY(e) - o.getY(e)),
                        2 === t && c.setZ(e, n.getZ(e) - o.getZ(e)),
                        3 === t && c.setW(e, n.getW(e) - o.getW(e));
          ...
          const y = m ? e.material : [e.material],
            g = m
              ? i.groups
          ...
          for (let e = 0, n = g.length; e < n; e++) {
            ...
            if (
              ...
              (void 0 === g[e].start && void 0 === g[e].count) ||
                (r += ':' + g[e].start + ':' + g[e].count),
                t.attributes.has(r)
            ...
            const r = this.processMaterial(y[g[e].materialIndex]);
        ...
        detectMeshQuantization(e, t) {
          if (this.extensionsUsed[Fc]) return;
          let n;
          ...
          Nc[r] &&
            Nc[r].includes(n) &&
            ((this.extensionsUsed[Fc] = !0),
            (this.extensionsRequired[Fc] = !0));
        }
        processCamera(e) {
          const t = this.json;
          t.cameras || (t.cameras = []);
          ...
          return (
            n
              ...
              : (r.perspective = {
                  ...
                  yfov: Mc.MathUtils.degToRad(e.fov),
                  zfar: e.far <= 0 ? 0.001 : e.far,
                  znear: e.near < 0 ? 0 : e.near
                }),
        ...
        processAnimation(e, t) {
          ...
          const o = (e = Lc.Utils.mergeMorphTargetTracks(e.clone(), t)).tracks,
            i = [],
            a = [];
          for (let e = 0; e < o.length; ++e) {
            const n = o[e],
              s = Mc.PropertyBinding.parseTrackName(n.name);
            let l = Mc.PropertyBinding.findNode(t, s.nodeName);
            const c = Vc[s.propertyName];
            if (
              ('bones' === s.objectName &&
                (l =
                  !0 === l.isSkinnedMesh
            ...
            c === Vc.morphTargetInfluences &&
              (f /= l.morphTargetInfluences.length),
              !0 ===
              n.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline
                ? ((p = 'CUBICSPLINE'), (f /= 3))
                : (p =
                    n.getInterpolation() === Mc.InterpolateDiscrete
                      ? 'STEP'
                      : 'LINEAR'),
              a.push({
                input: this.processAccessor(new Mc.BufferAttribute(n.times, u)),
                output: this.processAccessor(
                  new Mc.BufferAttribute(n.values, f)
                ),
                interpolation: p
              }),
              i.push({
        ...
        processNode(e) {
          ...
          if (n.trs) {
            const t = e.quaternion.toArray(),
              ...
              r = e.scale.toArray();
            Yc(t, [0, 0, 0, 1]) || (o.rotation = t),
              Yc(n, [0, 0, 0]) || (o.translation = n),
              Yc(r, [1, 1, 1]) || (o.scale = r);
          } else
        ...
        processInput(e) {
          ...
          for (let t = 0; t < e.length; t++)
            e[t] instanceof Mc.Scene ? this.processScene(e[t]) : n.push(e[t]);
            ...
            e.isDirectionalLight
              ...
              : e.isPointLight
                ...
                : e.isSpotLight &&
                  ...
                  (i.spot = {}),
                  (i.spot.innerConeAngle = (1 - e.penumbra) * e.angle),
      ...
      class iu {
        ...
        writeMaterial(e, t) {
          ...
          const n = this.writer,
            ...
            o = {};
          if (e.anisotropyMap) {
            const t = { index: n.processTexture(e.anisotropyMap) };
      ...
      class su {
        ...
        writeMaterial(e, t) {
          ...
          if (e.bumpMap) {
            ...
            n.applyTextureTransform(t, e.bumpMap), (o.bumpTexture = t);
          }
        ...
        writeNode(e, t) {
          ...
          for (let e = 0; e < r.count; e++)
            r.getMatrixAt(e, s),
              ...
              u.toArray(a, 3 * e);
          const p = {
            TRANSLATION: n.processAccessor(new Mc.BufferAttribute(o, 3)),
            ROTATION: n.processAccessor(new Mc.BufferAttribute(i, 4)),
            SCALE: n.processAccessor(new Mc.BufferAttribute(a, 3))
          };
          r.instanceColor && (p._COLOR_0 = n.processAccessor(r.instanceColor)),
            (t.extensions = t.extensions || {}),
            (t.extensions[this.name] = { attributes: p }),
      ...
      Lc.Utils = {
        ...
        mergeMorphTargetTracks: function (e, t) {
          ...
          for (let e = 0; e < o.length; ++e) {
            let i = o[e];
            const a = Mc.PropertyBinding.parseTrackName(i.name),
              s = Mc.PropertyBinding.findNode(t, a.nodeName);
            if (
            ...
            if (
              ...
              console.warn(
                ...
                (i = i.clone()),
                i.setInterpolation(Mc.InterpolateLinear);
            }
      ...
      (wu.styleTagTransform = Au()),
        (wu.setAttributes = yu()),
        (wu.insert = mu().bind(null, 'head')),
        (wu.domAPI = fu()),
        (wu.insertStyleElement = bu()),
        uu()(Cu.A, wu),
        Cu.A && Cu.A.locals && Cu.A.locals,
        (xu.prototype = {
          init: function () {
            var e = this;
            this.sceneEl.camera
              ? ((this.container = document.querySelector('.a-canvas')),
                (function (e) {
                  ...
                  t.A.on('cameraperspectivetoggle', function () {
                    kc(e.camera, Oc),
                      (n.camera = e.camera = s.perspective),
                      t.A.emit('cameratoggle', {
                        camera: e.camera,
                        value: 'perspective'
                      });
                  }),
                    t.A.on('cameraorthographictoggle', function (r) {
                      kc(e.camera, Oc),
          ...
          initUI: function () {
            var n = this;
            E.init(this), this.initEvents(), (this.selected = null);
            var r = document.createElement('div');
            (r.id = 'aframeInspector'),
              r.setAttribute('data-aframe-inspector', 'app'),
              document.body.appendChild(r),
              (0, e.H)(r).render((0, U.jsx)(Ec, {})),
          ...
          removeObject: function (e) {
            this.removeHelpers(e), t.A.emit('objectremove', e);
          },
          ...
          removeHelpers: function (e) {
            ...
            e.traverse(function (e) {
              ...
              r &&
                ...
                t.A.emit('helperremove', n.helpers[e.uuid]));
            });
          },
          selectEntity: function (e, n) {
            ...
            e && void 0 === n && t.A.emit('entityselect', e),
            this.helpers))
          ...
          initEvents: function () {
            ...
            t.A.on('entityselect', function (t) {
              ...
              t.A.on('entitycreate', function (n) {
                !(function (n, r) {
                  var o = document.createElement(n.element || 'a-entity');
                  for (var i in (n.id && (o.id = n.id),
                  n.class && o.setAttribute('class', n.class),
                  n.components))
                    o.setAttribute(i, n.components[i]);
                  o.addEventListener(
                    'loaded',
                    function () {
                      t.A.emit('entitycreated', o),
                        (function (t) {
                          e.selectEntity(t);
                        })(o);
                    },
          ...
          select: function (e) {
            this.selected !== e &&
              ((this.selected = e), t.A.emit('objectselect', e));
          },
          deselect: function () {
            this.select(null);
          },
          ...
          open: function (e) {
            (this.opened = !0),
              ...
              e && (this.selectEntity(e), t.A.emit('objectfocus', e.object3D)),
              (this.isFirstOpen = !1);
          },
          close: function () {
            (this.opened = !1),
              t.A.emit('inspectortoggle', !1),
